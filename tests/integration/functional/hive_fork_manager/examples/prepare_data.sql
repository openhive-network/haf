...
VALUES
( hafd.make_block_id(5, 0), 0, 1, 0, '{"type":"account_created_operation","value":{"initial_vesting_shares":{"amount":"0","precision":6,"nai":"@@000000037"},"initial_delegation":{"amount":"0","precision":6,"nai":"@@000000037"},"creator":"initminer","new_account_name":"account_5"}}' :: jsonb :: hafd.operation, hafd.operation_id(5, 1) );

INSERT INTO hafd.applied_hardforks(hardfork_num, block_id, hardfork_vop_id)
VALUES
( 1, hafd.make_block_id(5, 0), hafd.operation_id(5, 0) )
;
...
INSERT INTO hafd.operations(block_id, trx_in_block, op_type_id, op_pos, body_binary, id)
VALUES
    ( hafd.make_block_id(8, 1), 0, 1, 0, '{"type":"account_created_operation","value":{"initial_vesting_shares":{"amount":"0","precision":6,"nai":"@@000000037"},"initial_delegation":{"amount":"0","precision":6,"nai":"@@000000037"},"creator":"initminer","new_account_name":"account_8_revers"}}' :: jsonb :: hafd.operation, hafd.operation_id(8, 1) );
...
INSERT INTO hafd.operations(block_id, trx_in_block, op_type_id, op_pos, body_binary, id)
VALUES
    ( hafd.make_block_id(8, 2), 0, 1, 0, '{"type":"account_created_operation","value":{"initial_vesting_shares":{"amount":"0","precision":6,"nai":"@@000000037"},"initial_delegation":{"amount":"0","precision":6,"nai":"@@000000037"},"creator":"initminer","new_account_name":"account_8"}}' :: jsonb :: hafd.operation, hafd.operation_id(8, 1) );
