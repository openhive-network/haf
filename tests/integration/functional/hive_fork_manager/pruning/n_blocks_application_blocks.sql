...
BEGIN
    ...
    VALUES
           ( 1, 1, 1, hafd.make_block_id(1, 0), hafd.operation_id(1, 0), 0 )
         , ( 1, 1, 2, hafd.make_block_id(2, 0), hafd.operation_id(2, 0), 0 )
         , ( 2, 2, 1, hafd.make_block_id(2, 0), hafd.operation_id(2, 0), 0 )
         , ( 3, 3, 1, hafd.make_block_id(3, 0), hafd.operation_id(3, 0), 0 )
         , ( 4, 4, 1, hafd.make_block_id(4, 0), hafd.operation_id(4, 0), 0 )
    ;
...
BEGIN
    ...
    ASSERT NOT EXISTS (SELECT 1 FROM hafd.blocks WHERE hafd.block_id_to_num(block_id) = 1), 'block 1 was not removed';
