...
BEGIN
  ...
  op := '{"type": "comment_operation", "value": {"author": "tattoodjay", "body": "This is a cross post of [@tattoodjay/wednesday-walk-in-buttonwood-park](/hive-194913/@tattoodjay/wednesday-walk-in-buttonwood-park) by @tattoodjay.<br><br>A walk around Buttonwood Park", "json_metadata": "{\"app\":\"peakd/2023.2.2\",\"tags\":[\"cross-post\"],\"image\":[],\"original_author\":\"tattoodjay\", \"original_permlink\":\"wednesday-walk-in-buttonwood-park\"}", "parent_author": "", "parent_permlink": "hive-155530", "permlink": "wednesday-walk-in-buttonwood-park-hive-155530", "title": "Wednesday Walk in Buttonwood Park"}}'::JSONB::hive_data.operation::hive.comment_operation;
...
BEGIN
  ...
  op := '{"type": "comment_options_operation", "value": {"allow_curation_rewards": false, "allow_votes": true, "author": "tattoodjay", "extensions": [{"type":"comment_payout_beneficiaries", "value": {"beneficiaries": [{"account": "bob", "weight": 100}, {"account": "eva", "weight": 50}]}}], "max_accepted_payout": {"nai": "@@000000013", "amount": "332", "precision": 3}, "percent_hbd": 10000, "permlink": "wednesday-walk-in-buttonwood-park-hive-155530"}}'::JSONB::hive_data.operation::hive.comment_options_operation;
...
BEGIN
  ...
  op := '{"type":"vote_operation","value":{"voter":"anthrovegan","author":"carrinm","permlink":"actifit-carrinm-20200311t080841657z","weight":5000}}'::JSONB::hive_data.operation::hive.vote_operation;
...
BEGIN
  ...
  op := '{"type":"witness_set_properties_operation","value":{"owner":"holger80","props":[["account_creation_fee","b80b00000000000003535445454d0000"],["key","0295a26f54381a6dba8eb5dc7536e57db267685f9386c714ead9be39a905364a88"]],"extensions":[]}}'::JSONB::hive_data.operation::hive.witness_set_properties_operation;
...
BEGIN
  ...
  op := '{"type":"account_create_operation","value":{"fee":{"amount":"0","precision":3,"nai":"@@000000021"},"creator":"initminer","new_account_name":"dan","owner":{"weight_threshold":1,"account_auths":[],"key_auths": [["STM5vYywCazmCT3XSRhxoPPHEznNJqQHzSDnGsGYTKR6VkU88E1gH",1]]},"active":{"weight_threshold":1,"account_auths":[],"key_auths":[["STM5vYywCazmCT3XSRhxoPPHEznNJqQHzSDnGsGYTKR6VkU88E1gH",1]]},"posting": {"weight_threshold":1,"account_auths":[],"key_auths":[["STM5vYywCazmCT3XSRhxoPPHEznNJqQHzSDnGsGYTKR6VkU88E1gH",1]]},"memo_key":"STM5vYywCazmCT3XSRhxoPPHEznNJqQHzSDnGsGYTKR6VkU88E1gH"}}'::JSONB::hive_data.operation::hive.account_create_operation;
...
BEGIN
  ...
  op := '{"type":"account_update_operation","value":{"account":"alice","posting":{"weight_threshold":4,"account_auths":[],"key_auths":[["STM5P8syqoj7itoDjbtDvCMCb5W3BNJtUjws9v7TDNZKqBLmp3pQW",1]]},"memo_key":              "STM5P8syqoj7itoDjbtDvCMCb5W3BNJtUjws9v7TDNZKqBLmp3pQW","json_metadata":"{}"}}'::JSONB::hive_data.operation::hive.account_update_operation;
...
BEGIN
  ...
  op := '{"type":"account_witness_proxy_operation","value":{"account":"initminer","proxy":"alice"}}'::JSONB::hive_data.operation::hive.account_witness_proxy_operation;
...
BEGIN
  ...
  op := '{"type":"account_witness_vote_operation","value":{"account":"alice","witness":"initminer","approve":true}}'::JSONB::hive_data.operation::hive.account_witness_vote_operation;
...
BEGIN
  ...
  op := '{"type":"cancel_transfer_from_savings_operation","value":{"from":"alice","request_id":1}}'::JSONB::hive_data.operation::hive.cancel_transfer_from_savings_operation;
...
BEGIN
  ...
  op := '{"type":"change_recovery_account_operation","value":{"account_to_recover":"initminer","new_recovery_account":"alice","extensions":[]}}'::JSONB::hive_data.operation::hive.change_recovery_account_operation;
...
BEGIN
  ...
  op := '{"type":"claim_account_operation","value":{"creator":"initminer","fee":{"amount":"0","precision":3,"nai":"@@000000021"},"extensions":[]}}'::JSONB::hive_data.operation::hive.claim_account_operation;
...
BEGIN
  ...
  op := '{"type":"claim_reward_balance_operation","value":{"account":"edgar0ah","reward_hive":{"amount":"0","precision":3,"nai":"@@000000021"},"reward_hbd":{"amount":"1","precision":3,"nai":"@@000000013"},"reward_vests":  {"amount":"1","precision":6,"nai":"@@000000037"}}}'::JSONB::hive_data.operation::hive.claim_reward_balance_operation;
...
BEGIN
  ...
  op := '{"type":"collateralized_convert_operation","value":{"owner":"carol3ah","requestid":0,"amount":{"amount":"22102","precision":3,"nai":"@@000000021"}}}'::JSONB::hive_data.operation::hive.collateralized_convert_operation;
...
BEGIN
  ...
  op := '{"type": "convert_operation","value": {"amount": {"amount": "127144","nai": "@@000000013","precision": 3},"owner": "gtg","requestid": 1467663446}}'::JSONB::hive_data.operation::hive.convert_operation;
...
BEGIN
  ...
  op := '{"type":"custom_json_operation","value":{"required_auths":[],"required_posting_auths":["alice"],"id":"follow","json":"{\"type\":\"follow_operation\",\"value\":{\"follower\":\"alice\",\"following\":\"@bob\",\"what\":[\"blog\"]}}"}}'::JSONB::hive_data.operation::hive.custom_json_operation;
...
BEGIN
  raise notice 'checking conversion to custom_json_operation';
  op := '{"type":"custom_json_operation","value":{"required_auths":[],"required_posting_auths":["alice"],"id":"follow"}}'::JSONB::hive_data.operation::hive.custom_json_operation;
...
BEGIN
  ...
  op := '{"type":"decline_voting_rights_operation","value":{"account":"initminer","decline":true}}'::JSONB::hive_data.operation::hive.decline_voting_rights_operation;
...
BEGIN
  ...
  op := '{"type":"delegate_vesting_shares_operation","value":{"delegator":"alice","delegatee":"bob","vesting_shares":{"amount":"1000000","precision":6,"nai":"@@000000037"}}}'::JSONB::hive_data.operation::hive.delegate_vesting_shares_operation;
...
BEGIN
  ...
  op := '{"type": "delete_comment_operation","value": {"author": "camilla","permlink": "re-shenanigator-re-kalipo-re-camilla-girl-with-a-pink-bow-20160912t221343480z"}}'::JSONB::hive_data.operation::hive.delete_comment_operation;
...
BEGIN
  ...
  op := '{"type":"escrow_approve_operation","value":{"from":"initminer","to":"alice","agent":"bob","who":"bob","escrow_id":2,"approve":true}}'::JSONB::hive_data.operation::hive.escrow_approve_operation;
...
BEGIN
  ...
  op := '{"type":"escrow_dispute_operation","value":{"from":"initminer","to":"alice","agent":"bob","who":"initminer","escrow_id":3}}'::JSONB::hive_data.operation::hive.escrow_dispute_operation;
...
BEGIN
  ...
  op := '{"type":"escrow_release_operation","value":{"from":"initminer","to":"alice","agent":"bob","who":"bob","receiver":"alice","escrow_id":1,"hbd_amount":{"amount":"10000","precision":3,"nai":"@@000000013"},"hive_amount":{"amount":"10000", "precision":3,"nai":"@@000000021"}}}'::JSONB::hive_data.operation::hive.escrow_release_operation;
...
BEGIN
  ...
  op := '{"type":"escrow_transfer_operation","value":{"from":"initminer","to":"alice","hbd_amount":{"amount":"10000","precision":3,"nai":"@@000000013"},"hive_amount":{"amount":"10000","precision":3,"nai":"@@000000021"},"escrow_id":10,"agent": "bob","fee":{"amount":"10000","precision":3,"nai":"@@000000013"},"json_meta":"{}","ratification_deadline":"2030-01-01T00:00:00","escrow_expiration":"2030-06-01T00:00:00"}}'::JSONB::hive_data.operation::hive.escrow_transfer_operation;
...
BEGIN
  ...
  op := '{"type":"feed_publish_operation","value":{"publisher":"initminer","exchange_rate":{"base":{"amount":"1","precision":3,"nai":"@@000000013"},"quote":{"amount":"2","precision":3,"nai":"@@000000021"}}}}'::JSONB::hive_data.operation::hive.feed_publish_operation;
...
BEGIN
  ...
  op := '{"type":"limit_order_cancel_operation","value":{"owner":"alice","orderid":1}}'::JSONB::hive_data.operation::hive.limit_order_cancel_operation;
...
BEGIN
  ...
  op := '{"type":"limit_order_create_operation","value":{"owner":"alice","orderid":1000,"amount_to_sell":{"amount":"1000","precision":3,"nai":"@@000000021"},"min_to_receive":{"amount":"500","precision":3,"nai":"@@000000013"},"fill_or_kill":false,"expiration":"2023-01-02T11:43:07"}}'::JSONB::hive_data.operation::hive.limit_order_create_operation;
...
BEGIN
  ...
  op := '{"type": "pow2_operation","value": {"props": {"account_creation_fee": {"amount": "1","nai": "@@000000021","precision": 3},"hbd_interest_rate": 1000,"maximum_block_size": 131072},"work": {"type": "pow2","value": {"input": {"nonce": "2363830237862599931","prev_block": "003ead0c90b0cd80e9145805d303957015c50ef1","worker_account": "thedao"},"pow_summary": 3878270667}}}}'::JSONB::hive_data.operation::hive.pow2_operation;
  ...
  op := '{"type": "pow2_operation","value": {"props": {"account_creation_fee": {"amount": "2","nai": "@@000000021","precision": 3},"hbd_interest_rate": 1000,"maximum_block_size": 131070},"work": {"type": "equihash_pow","value": {"proof": {"n": 7, "k": 8, "seed": "x"}, "prev_block":"003ead0c90b0cd80e9145805d303957015c50ef0", "pow_summary":1}}}}'::JSONB::hive_data.operation::hive.pow2_operation;
...
BEGIN
  ...
  op := '{"type":"recurrent_transfer_operation","value":{"from":"alice","to":"bob","amount":{"amount":"5000","precision":3,"nai":"@@000000021"},"memo":"memo","recurrence":720,"executions":12,"extensions":[]}}'::JSONB::hive_data.operation::hive.recurrent_transfer_operation;
...
BEGIN
  ...
  op := '{"type": "request_account_recovery_operation","value": {"account_to_recover": "tulpa","extensions": [],"new_owner_authority": {"account_auths": [],"key_auths": [["STM6wxeXR9kg8uu7vX5LS4HBgKw8sdqHBpzAaacqPwPxYfRx9h5bS",2]],"weight_threshold": 1},"recovery_account": "nalesnik"}}'::JSONB::hive_data.operation::hive.request_account_recovery_operation;
...
BEGIN
  ...
  op := '{"type": "reset_account_operation","value": {"account_to_reset": "tulpa","new_owner_authority": {"account_auths": [],"key_auths": [["STM6wxeXR9kg8uu7vX5LS4HBgKw8sdqHBpzAaacqPwPxYfRx9h5bS",2]],"weight_threshold": 1},"reset_account": "nalesnik"}}'::JSONB::hive_data.operation::hive.reset_account_operation;
...
BEGIN
  ...
  op := '{"type": "set_reset_account_operation","value": {"account": "tulpa","current_reset_account": "old_account", "reset_account": "new_account"}}'::JSONB::hive_data.operation::hive.set_reset_account_operation;
...
BEGIN
  ...
  op := '{"type":"set_withdraw_vesting_route_operation","value":{"from_account":"alice","to_account":"bob","percent":30,"auto_vest":true}}'::JSONB::hive_data.operation::hive.set_withdraw_vesting_route_operation;
...
BEGIN
  ...
  op := '{"type":"transfer_from_savings_operation","value":{"from":"alice","request_id":1000,"to":"bob","amount":{"amount":"1000","precision":3,"nai":"@@000000021"},"memo":"memo"}}'::JSONB::hive_data.operation::hive.transfer_from_savings_operation;
...
BEGIN
  ...
  op := '{"type":"transfer_operation","value":{"from":"initminer","to":"alice","amount":{"amount":"10000","precision":3,"nai":"@@000000021"},"memo":"memo"}}'::JSONB::hive_data.operation::hive.transfer_operation;
...
BEGIN
  ...
  op := '{"type":"transfer_to_savings_operation","value":{"from":"initminer","to":"alice","amount":{"amount":"100000","precision":3,"nai":"@@000000021"},"memo":"memo"}}'::JSONB::hive_data.operation::hive.transfer_to_savings_operation;
...
BEGIN
  ...
  op := '{"type":"transfer_to_vesting_operation","value":{"from":"initminer","to":"alice","amount":{"amount":"100000","precision":3,"nai":"@@000000021"}}}'::JSONB::hive_data.operation::hive.transfer_to_vesting_operation;
...
BEGIN
  ...
  op := '{"type":"withdraw_vesting_operation","value":{"account":"alice","vesting_shares":{"amount":"10000000","precision":6,"nai":"@@000000037"}}}'::JSONB::hive_data.operation::hive.withdraw_vesting_operation;
...
BEGIN
  ...
  op := '{"type":"witness_update_operation","value":{"owner":"alice","url":"http://url.html","block_signing_key":"STM5P8syqoj7itoDjbtDvCMCb5W3BNJtUjws9v7TDNZKqBLmp3pQW","props":{"account_creation_fee":{"amount":"10000", "precision":3,"nai":"@@000000021"},"maximum_block_size":131072,"hbd_interest_rate":1000},"fee":{"amount":"0","precision":3,"nai":"@@000000021"}}}'::JSONB::hive_data.operation::hive.witness_update_operation;
...
BEGIN
  ...
  op := '{"type":"create_proposal_operation","value":{"creator":"alice","receiver":"bob","start_date":"2031-01-01T00:00:01","end_date":"2031-06-01T23:59:59","daily_pay":{"amount":"1000000","precision":3,"nai":"@@000000013"},"subject":"subject-1","permlink":"permlink","extensions":[]}}'::JSONB::hive_data.operation::hive.create_proposal_operation;
...
BEGIN
  ...
  op := '{"type":"proposal_pay_operation","value":{"proposal_id":0,"receiver":"steem.dao","payer":"steem.dao","payment":{"amount":"157","precision":3,"nai":"@@000000013"}}}'::JSONB::hive_data.operation::hive.proposal_pay_operation;
...
BEGIN
  ...
  op := '{"type":"remove_proposal_operation","value":{"proposal_owner":"initminer","proposal_ids":[6],"extensions":[]}}'::JSONB::hive_data.operation::hive.remove_proposal_operation;
...
BEGIN
  ...
  op := '{"type":"update_proposal_operation","value":{"proposal_id":0,"creator":"alice","daily_pay":{"amount":"10000","precision":3,"nai":"@@000000013"},"subject":"subject-1","permlink":"permlink","extensions":[{"type": "update_proposal_end_date","value":{"end_date":"2031-05-01T00:00:00"}}]}}'::JSONB::hive_data.operation::hive.update_proposal_operation;
...
BEGIN
  ...
  op := '{"type":"update_proposal_votes_operation","value":{"voter":"alice","proposal_ids":[0],"approve":true,"extensions":[]}}'::JSONB::hive_data.operation::hive.update_proposal_votes_operation;
...
BEGIN
  ...
  op := '{"type": "account_created_operation","value": {"creator": "steem","initial_delegation": {"amount": "0","nai": "@@000000037","precision": 6},"initial_vesting_shares": {"amount": "11541527333","nai": "@@000000037","precision": 6},"new_account_name": "jevt"}}'::JSONB::hive_data.operation::hive.account_created_operation;
...
BEGIN
  ...
  op := '{"type": "changed_recovery_account_operation","value": {"account": "barrie","new_recovery_account": "boombastic_new","old_recovery_account": "boombastic_old"}}'::JSONB::hive_data.operation::hive.changed_recovery_account_operation;
...
BEGIN
  ...
  op := '{"type":"clear_null_account_balance_operation","value":{"total_cleared":[{"amount":"2000","precision":3,"nai":"@@000000021"},{"amount":"21702525","precision":3,"nai":"@@000000013"}]}}'::JSONB::hive_data.operation::hive.clear_null_account_balance_operation;
...
BEGIN
  ...
  op := '{"type": "comment_payout_update_operation","value": {"author": "camilla","permlink": "re-camilla-re-btcbtcbtc20155-re-camilla-my-ladybug-drawing-20160806t131222091z"}}'::JSONB::hive_data.operation::hive.comment_payout_update_operation;
...
BEGIN
  ...
  op := '{"type": "comment_reward_operation","value": {"author": "camilla","author_rewards": 401,"beneficiary_payout_value": {"amount": "0","nai": "@@000000013","precision": 3},"curator_payout_value": {"amount": "89", "nai": "@@000000013","precision": 3},"payout": {"amount": "366","nai": "@@000000013","precision": 3},"permlink": "re-spetey-re-camilla-re-spetey-re-clains-free-will-and-conscious-freedom-20160814t111905211z", "total_payout_value": {"amount": "276","nai": "@@000000013","precision": 3}}}'::JSONB::hive_data.operation::hive.comment_reward_operation;
...
BEGIN
  ...
  op := '{"type":"consolidate_treasury_balance_operation","value":{"total_moved":[{"amount":"83353473585","precision":3,"nai":"@@000000021"},{"amount":"560371025","precision":3,"nai":"@@000000013"}]}}'::JSONB::hive_data.operation::hive.consolidate_treasury_balance_operation;
...
BEGIN
  ...
  op := '{"type": "curation_reward_operation","value": {"author": "acidyo","permlink": "gemo-dna-introduction-and-prologue-sci-fi-action-rpg-futurism","curator": "camilla","payout_must_be_claimed": false,"reward": {"amount": "291037297","nai": "@@000000037","precision": 6}}}'::JSONB::hive_data.operation::hive.curation_reward_operation;
...
BEGIN
  ...
  op := '{"type":"delayed_voting_operation","value":{"voter":"balte","votes":"33105558106560"}}'::JSONB::hive_data.operation::hive.delayed_voting_operation;
...
BEGIN
  ...
  op := '{"type":"expired_account_notification_operation","value":{"account":"spiritrider"}}'::JSONB::hive_data.operation::hive.expired_account_notification_operation;
...
BEGIN
  ...
  op := '{"type":"failed_recurrent_transfer_operation","value":{"from":"blackknight1423","to":"aa111","amount":{"amount":"1000","precision":3,"nai":"@@000000021"},"memo":"","consecutive_failures":1,"remaining_executions":0,"deleted":false}}'::JSONB::hive_data.operation::hive.failed_recurrent_transfer_operation;
...
BEGIN
  ...
  op := '{"type":"fill_collateralized_convert_request_operation","value":{"owner":"carol3ah","requestid":0,"amount_in":{"amount":"11050","precision":3,"nai":"@@000000021"},"amount_out":{"amount":"10524","precision":3,"nai":"@@000000013"},"excess_collateral":{"amount":"11052","precision":3,"nai":"@@000000021"}}}'::JSONB::hive_data.operation::hive.fill_collateralized_convert_request_operation;
...
BEGIN
  ...
  op := '{"type": "fill_convert_request_operation","value": {"amount_in": {"amount": "2000000","nai": "@@000000013","precision": 3},"amount_out": {"amount": "605143","nai": "@@000000021","precision": 3},"owner": "xeroc","requestid": 1468315395}}'::JSONB::hive_data.operation::hive.fill_convert_request_operation;
...
BEGIN
  ...
  op := '{"type": "fill_order_operation","value": {"current_orderid": 10,"current_owner": "ledzeppelin","current_pays": {"amount": "5000000","nai": "@@000000021","precision": 3},"open_orderid": 556,"open_owner": "adm", "open_pays": {"amount": "14075200","nai": "@@000000013","precision": 3}}}'::JSONB::hive_data.operation::hive.fill_order_operation;
...
BEGIN
  ...
  op := '{"type":"fill_recurrent_transfer_operation","value":{"from":"deathwing","to":"rishi556","amount":{"amount":"1000","precision":3,"nai":"@@000000021"},"memo":"test","remaining_executions":4}}'::JSONB::hive_data.operation::hive.fill_recurrent_transfer_operation;
...
BEGIN
  ...
  op := '{"type":"fill_transfer_from_savings_operation","value":{"from":"alice_from","to":"alice_to","amount":{"amount":"7","precision":3,"nai":"@@000000021"},"request_id":1,"memo":""}}'::JSONB::hive_data.operation::hive.fill_transfer_from_savings_operation;
...
BEGIN
  ...
  op := '{"type": "fill_vesting_withdraw_operation","value": {"deposited": {"amount": "259543","nai": "@@000000021","precision": 3},"from_account": "adm_from","to_account": "adm_to","withdrawn": {"amount": "1569493022171", "nai": "@@000000037","precision": 6}}}'::JSONB::hive_data.operation::hive.fill_vesting_withdraw_operation;
...
BEGIN
  ...
  op := '{"type":"hardfork_hive_restore_operation","value":{"account":"angelina6688","treasury":"steem.dao","hbd_transferred":{"amount":"25","precision":3,"nai":"@@000000013"},"hive_transferred":{"amount":"2787",  "precision":3,"nai":"@@000000021"}}}'::JSONB::hive_data.operation::hive.hardfork_hive_restore_operation;
...
BEGIN
  ...
  op := '{"type": "hardfork_operation","value": {"hardfork_id": 7}}'::JSONB::hive_data.operation::hive.hardfork_operation;
...
BEGIN
  ...
  op := '{"type": "ineffective_delete_comment_operation","value": {"author": "jsc","permlink": "re-vadimberkut8-just-test-20160603t163718014z"}}'::JSONB::hive_data.operation::hive.ineffective_delete_comment_operation;
...
BEGIN
  ...
  op := '{"type": "interest_operation","value": {"interest": {"amount": "2260","nai": "@@000000013","precision": 3},"is_saved_into_hbd_balance": true,"owner": "camilla"}}'::JSONB::hive_data.operation::hive.interest_operation;
...
BEGIN
  ...
  op := '{"type":"limit_order_cancelled_operation","value":{"seller":"carol3ah","orderid":1,"amount_back":{"amount":"11400","precision":3,"nai":"@@000000021"}}}'::JSONB::hive_data.operation::hive.limit_order_cancelled_operation;
...
BEGIN
  ...
  op := '{"type": "liquidity_reward_operation","value": {"owner": "adm","payout": {"amount": "1200000","nai": "@@000000021","precision": 3}}}'::JSONB::hive_data.operation::hive.liquidity_reward_operation;
...
BEGIN
  ...
  op := '{"type": "pow_reward_operation","value": {"reward": {"amount": "21000","nai": "@@000000021","precision": 3},"worker": "admin"}}'::JSONB::hive_data.operation::hive.pow_reward_operation;
...
BEGIN
  ...
  op := '{"type": "producer_reward_operation","value": {"producer": "blocktrades","vesting_shares": {"amount": "9181480764","nai": "@@000000037","precision": 6}}}'::JSONB::hive_data.operation::hive.producer_reward_operation;
...
BEGIN
  ...
  op := '{"type":"return_vesting_delegation_operation","value":{"account":"alice4ah","vesting_shares":{"amount":"1","precision":6,"nai":"@@000000037"}}}'::JSONB::hive_data.operation::hive.return_vesting_delegation_operation;
...
BEGIN
  ...
  op := '{"type":"shutdown_witness_operation","value":{"owner":"mining1"}}'::JSONB::hive_data.operation::hive.shutdown_witness_operation;
...
BEGIN
  ...
  op := '{"type":"system_warning_operation","value":{"message":"SIX OPERATION"}}'::JSONB::hive_data.operation::hive.system_warning_operation;
...
BEGIN
  ...
  op := '{"type": "transfer_to_vesting_completed_operation","value": {"from_account": "blocktrades","hive_vested": {"amount": "98876","nai": "@@000000021","precision": 3},"to_account": "michaeldodridge","vesting_shares_received": {"amount": "307332601851","nai": "@@000000037","precision": 6}}}'::JSONB::hive_data.operation::hive.transfer_to_vesting_completed_operation;
...
BEGIN
  ...
  op := '{"type":"witness_block_approve_operation","value":{"witness":"abc","block_id": "002104af55d5c492c8c134b5a55c89eac8210a86"}}'::JSONB::hive_data.operation::hive.witness_block_approve_operation;
...
BEGIN
  ...
  op := '{"type":"vesting_shares_split_operation","value":{"owner":"initminer","vesting_shares_before_split":{"amount":"1000000","precision":6,"nai":"@@000000037"},"vesting_shares_after_split":{"amount":"1000000000000", "precision":6,"nai":"@@000000037"}}}'::JSONB::hive_data.operation::hive.vesting_shares_split_operation;
...
BEGIN
  ...
  op := '{"type":"dhf_funding_operation","value":{"treasury":"hive.fund","additional_funds":{"amount":"9","precision":3,"nai":"@@000000013"}}}'::JSONB::hive_data.operation::hive.dhf_funding_operation;
...
BEGIN
  ...
  op := '{"type":"dhf_conversion_operation","value":{"treasury":"hive.fund","hive_amount_in":{"amount":"3333","precision":3,"nai":"@@000000021"},"hbd_amount_out":{"amount":"3334","precision":3,"nai":"@@000000013"}}}'::JSONB::hive_data.operation::hive.dhf_conversion_operation;
...
BEGIN
  ...
  op := '{"type": "producer_missed_operation","value": {"producer": "dantheman5"}}'::JSONB::hive_data.operation::hive.producer_missed_operation;
...
BEGIN
  ...
  op := '{"type":"proposal_fee_operation","value":{"creator":"alice7ah","treasury":"hive.fund","proposal_id":2,"fee":{"amount":"10000","precision":3,"nai":"@@000000013"}}}'::JSONB::hive_data.operation::hive.proposal_fee_operation;
...
BEGIN
  ...
  op := '{"type":"collateralized_convert_immediate_conversion_operation","value":{"owner":"carol3ah","requestid":3,"hbd_out":{"amount":"10524","precision":3,"nai":"@@000000013"}}}'::JSONB::hive_data.operation::hive.collateralized_convert_immediate_conversion_operation;
...
DROP PROCEDURE IF EXISTS check_operation_to_escrow_approved_operation;
CREATE PROCEDURE check_operation_to_escrow_approved_operation()
LANGUAGE 'plpgsql'
AS
$BODY$
DECLARE
  op hive.escrow_approved_operation;
BEGIN
  raise notice 'checking conversion to escrow_approved_operation';
  op := '{"type":"escrow_approved_operation","value":{"from":"alice6ah","to":"ben6ah","agent":"carol6ah","escrow_id":30,"fee":{"amount":"1","precision":3,"nai":"@@000000021"}}}'::JSONB::hive_data.operation::hive.escrow_approved_operation;
  ASSERT (select op."from" = 'alice6ah'), format('Unexpected value of escrow_approved_operation.from: %s', op."from");
  ASSERT (select op."to" = 'ben6ah'), format('Unexpected value of escrow_approved_operation.to: %s', op."to");
  ASSERT (select op.agent = 'carol6ah'), format('Unexpected value of escrow_approved_operation.agent: %s', op.agent);
  ASSERT (select op.escrow_id = 30), format('Unexpected value of escrow_approved_operation.escrow_id: %s', op.escrow_id);
  ASSERT (select op.fee = '(1,3,@@000000021)'::hive.asset), format('Unexpected value of escrow_approved_operation.fee: %s', op.fee);
END;
$BODY$
;
...
BEGIN
  ...
  op := '{"type":"escrow_rejected_operation","value":{"from":"alice6ah","to":"ben6ah","agent":"carol6ah","escrow_id":31,"hbd_amount":{"amount":"0","precision":3,"nai":"@@000000013"},"hive_amount":{"amount":"7","precision":3,"nai":"@@000000021"},"fee":{"amount":"1","precision":3,"nai":"@@000000021"}}}'::JSONB::hive_data.operation::hive.escrow_rejected_operation;
...
BEGIN
  ...
  op := '{"type":"proxy_cleared_operation","value":{"account":"lafona5","proxy":"lafona"}}'::JSONB::hive_data.operation::hive.proxy_cleared_operation;
...
BEGIN
  ...
  op := '{"type":"declined_voting_rights_operation","value":{"account":"lafona5"}}'::JSONB::hive_data.operation::hive.declined_voting_rights_operation;
