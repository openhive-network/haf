...
BEGIN
    ...
    ASSERT (SELECT hive.convert_to_block_num('2016-06-22 19:10:56-07')) = 2, 'Results on > block 2 do not match';
    ASSERT (SELECT hive.convert_to_block_num('2016-06-22 19:10:25-07')) = 2, 'Results on = block 2 timestamp do not match';
