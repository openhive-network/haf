...
$BODY$
DECLARE
  _pattern0 hive.impacted_balances_return[] = '';
...
SELECT ARRAY_AGG(ROW(f.account_name, f.amount, f.asset_precision, f.asset_symbol_nai)::hive.impacted_balances_return)
INTO _test11
FROM hive.get_impacted_balances('{"type":"witness_update_operation","value":{"owner":"steempty","url":"fmooo/steemd-docker","block_signing_key":"STM8LoQjQqJHvotqBo7HjnqmUbFW9oJ2theyqonzUd9DdJ7YYHsvD","props":{"account_creation_fee":{"amount":"100000","precision":3,"nai":"@@000000021"},"maximum_block_size":131072,"hbd_interest_rate":1000},"fee":{"amount":"0","precision":3,"nai":"@@000000021"}}}', FALSE) f
;
...
SELECT ARRAY_AGG(ROW(f.account_name, f.amount, f.asset_precision, f.asset_symbol_nai)::hive.impacted_balances_return)
INTO _test22
FROM hive.get_impacted_balances('{"type":"claim_account_operation","value":{"creator":"blocktrades","fee":{"amount":"0","precision":3,"nai":"@@000000021"},"extensions":[]}}', FALSE) f
;
...
SELECT ARRAY_AGG(ROW(f.account_name, f.amount, f.asset_precision, f.asset_symbol_nai)::hive.impacted_balances_return)
INTO _test53
FROM hive.get_impacted_balances('{"type":"comment_reward_operation","value":{"author":"lat-nayar","permlink":"hello-i-am-lat","payout":{"amount":"981248","precision":3,"nai":"@@000000013"},"author_rewards":2230120,"total_payout_value":{"amount":"490626","precision":3,"nai":"@@000000013"},"curator_payout_value":{"amount":"490621","precision":3,"nai":"@@000000013"},"beneficiary_payout_value":{"amount":"0","precision":3,"nai":"@@000000013"}}}', FALSE) f
;
...
SELECT ARRAY_AGG(ROW(f.account_name, f.amount, f.asset_precision, f.asset_symbol_nai)::hive.impacted_balances_return)
INTO _test78
FROM hive.get_impacted_balances('{"type":"pow_reward_operation","value":{"worker":"initminer","reward":{"amount":"0","precision":3,"nai":"@@000000021"}}}', FALSE) f
;
...
SELECT ARRAY_AGG(ROW(f.account_name, f.amount, f.asset_precision, f.asset_symbol_nai)::hive.impacted_balances_return)
INTO _test80
FROM hive.get_impacted_balances('{"type":"account_created_operation","value":{"new_account_name":"miners","creator":"miners","initial_vesting_shares":{"amount":"0","precision":6,"nai":"@@000000037"},"initial_delegation":{"amount":"0","precision":6,"nai":"@@000000037"}}}', FALSE) f
;
...
SELECT ARRAY_AGG(ROW(f.account_name, f.amount, f.asset_precision, f.asset_symbol_nai)::hive.impacted_balances_return)
INTO _test91
FROM hive.get_impacted_balances('{"type":"proxy_cleared_operation","value":{"account":"bunkermining","proxy":"datasecuritynode","clear":false}}', FALSE) f
;
