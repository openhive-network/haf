...
BEGIN
  ...
  ASSERT ((SELECT hive.get_legacy_style_operation(comment_operation :: jsonb :: hive.operation)::VARCHAR) = '["comment",{"parent_author":"steemit","parent_permlink":"firstpost","author":"admin","permlink":"firstpost","title":"TITLE","body":"First Reply! Lets get this **party** started","json_metadata":"{}"}]'), 'operation "comment_operation/whole-body" error';
  ...
  ASSERT ((SELECT hive.get_legacy_style_operation(transfer_operation :: jsonb :: hive.operation)::VARCHAR) = '["transfer",{"from":"faddy3","to":"faddy","amount":"40.000 HIVE","memo":"this is a test"}]'), 'operation "transfer_operation/whole-body" error';
