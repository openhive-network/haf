...
BEGIN
    ...
    VALUES
          ( hafd.make_block_id(1, 0), 1, 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"BLOCK ONE OP"}}' :: jsonb :: hafd.operation )
        , ( hafd.make_block_id(2, 0), 1, 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"BLOCK TWO OP"}}' :: jsonb :: hafd.operation )
        , ( hafd.make_block_id(3, 0), 1, 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"BLOCK THREE OP"}}' :: jsonb :: hafd.operation )
        , ( hafd.make_block_id(3, 0), 2, 2, -1, 0, '{"type":"system_warning_operation","value":{"message":"BLOCK THREE VOP"}}' :: jsonb :: hafd.operation )  -- Virtual op (type 2), trx_in_block=-1
        , ( hafd.make_block_id(4, 0), 1, 1, 0, 0, '{"type":"system_warning_operation","value":{"message":"BLOCK FOUR OP"}}' :: jsonb :: hafd.operation )
