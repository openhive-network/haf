...
BEGIN
    ...
    __operation1_1 = ( 1, 101, 0, 0, 1, '2016-06-22 19:10:21-07'::timestamp, ROW('ZERO OPERATION')::hive.system_warning_operation );
    __operation2_1 = ( 2, 101, 1, 0, 2, '2016-06-22 19:10:21-07'::timestamp, ROW('ONE OPERATION')::hive.system_warning_operation );
...
BEGIN
    ...
    ASSERT ( SELECT COUNT(*) FROM hive.operations_reversible
        WHERE
              ...
              AND body :: hive.hive_operations = ROW('ZERO OPERATION')::hive.system_warning_operation :: variant.variant
              AND fork_id = 1
    ...
    ASSERT ( SELECT COUNT(*) FROM hive.operations_reversible
         WHERE
           ...
           AND op_type_id = 2
           AND timestamp = '2016-06-22 19:10:21-07'::timestamp
           AND body :: hive.hive_operations = ROW('ONE OPERATION')::hive.system_warning_operation :: hive.hive_operations
           AND fork_id = 1
