...
BEGIN
    SELECT * FROM hive.get_block( 7 ) INTO __block;
    RAISE NOTICE 'Block = %', __block;

    ASSERT __block.previous = '\xCAFE70'::bytea, 'Incorrect previous block hash';
    ASSERT __block.timestamp = '2016-06-22 19:10:27-07'::timestamp, 'Incorrect timestamp';
    ASSERT __block.witness = 'initminer', 'Incorrect witness name';
    ASSERT __block.transaction_merkle_root = '\x4007'::bytea, 'Incorrect transaction merkle root';
    ASSERT __block.extensions = E'[]'::jsonb, 'Incorrect extensions';
    ASSERT __block.witness_signature = '\x2157'::bytea, 'Incorrect witness signature';

    ASSERT __block.transactions IS NULL, 'Incorrect transactions array';
    ASSERT __block.block_id = '\xBADD70'::bytea, 'Incorrect block_id';
    ASSERT __block.signing_key = 'STM65w', 'Incorrect signing_key';
    ASSERT __block.transaction_ids IS NULL, 'Incorrect transaction_ids array';
END
$BODY$
;
