...
$BODY$
BEGIN
    INSERT INTO hive.hived_connections( block_num, git_sha, time ) VALUES( 100000, '1234567890'::TEXT, now()  );
END
$BODY$
;
...
$BODY$
BEGIN
    -- last restarting hived time override contexts last_active_at
    ASSERT hive.app_context_is_attached( 'alice' ) = TRUE, 'alice is not attached';
    ASSERT hive.app_context_is_attached( 'bob' ) = TRUE, 'bob is not attached';
