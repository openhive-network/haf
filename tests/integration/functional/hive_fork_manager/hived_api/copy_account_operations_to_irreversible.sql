...
BEGIN
    ...
    VALUES
         ...
         , ( 8, 8, 1, hafd.operation_id(7, 1, 0), 1 ) -- must be overriden by fork 2
         ...
         , ( 9, 9, 3, hafd.operation_id(9, 1, 0), 3 )
         , ( 10, 10, 3, hafd.operation_id(10, 1, 0), 3 )
...
BEGIN
    ASSERT NOT EXISTS (
        ...
        EXCEPT SELECT * FROM ( VALUES
                 ...
                 , ( 6, 6, 1, hafd.operation_id(6, 1, 0) )
                 , ( 7, 7, 2, hafd.operation_id(7, 1, 0) )
                 , ( 8, 8, 2, hafd.operation_id(7, 1, 1) )
                 , ( 9, 9, 3, hafd.operation_id(7, 1, 0) )
                 ) as pattern
