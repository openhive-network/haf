...
BEGIN
    ...
    VALUES
         ...
         , ( 6, 0, 0, 1, 0, '{"type":"system_warning_operation","value":{"message":"SIX OPERATION"}}' :: jsonb :: hafd.operation )
         , ( 7, 0, 0, 1, 0, '{"type":"system_warning_operation","value":{"message":"SEVEN2 OPERATION"}}' :: jsonb :: hafd.operation )
         , ( 7, 1, 0, 1, 1, '{"type":"system_warning_operation","value":{"message":"SEVEN21 OPERATION"}}' :: jsonb :: hafd.operation )
         , ( 8, 0, 0, 1, 0, '{"type":"system_warning_operation","value":{"message":"EAIGHT2 OPERATION"}}' :: jsonb :: hafd.operation )
    ;
    ...
    INSERT INTO hafd.account_operations(account_id, transacting_account_id, account_op_seq_no, block_num, op_pos_in_block, op_type_id)
    VALUES
           ( 1, 1, 1, 1, 0, 1)
         , ( 1, 1, 2, 2, 0, 1)
         , ( 2, 2, 1, 2, 0, 1)
    ...
    VALUES
         ...
         , ( 8, 8, 1, 7, 0, 1, 1 ) -- must be overriden by fork 2
...
BEGIN
    ASSERT NOT EXISTS (
        ...
        EXCEPT SELECT * FROM ( VALUES
                   ( 1, 1, 1, 1, 0, 1::SMALLINT )
                 , ( 1, 1, 2, 2, 0, 1::SMALLINT )
                 , ( 2, 2, 1, 2, 0, 1::SMALLINT )
                 , ( 3, 3, 1, 3, 0, 1::SMALLINT )
                 , ( 4, 4, 1, 4, 0, 1::SMALLINT )
                 , ( 5, 5, 1, 5, 0, 1::SMALLINT )
                 , ( 6, 6, 1, 6, 0, 1::SMALLINT )
                 , ( 7, 7, 2, 7, 0, 1::SMALLINT )
                 , ( 8, 8, 2, 7, 1, 1::SMALLINT )
                 , ( 9, 9, 3, 7, 0, 1::SMALLINT )
                 ) as pattern
