...
BEGIN
    ...
    VALUES
         ...
         , ( hafd.operation_id(6, 0), 0, 1, 0, '{"type":"system_warning_operation","value":{"message":"SIX OPERATION"}}' :: jsonb :: hafd.operation )
         , ( hafd.operation_id(7, 0), 0, 1, 0, '{"type":"system_warning_operation","value":{"message":"SEVEN2 OPERATION"}}' :: jsonb :: hafd.operation )
         , ( hafd.operation_id(7, 1), 0, 1, 1, '{"type":"system_warning_operation","value":{"message":"SEVEN21 OPERATION"}}' :: jsonb :: hafd.operation )
         , ( hafd.operation_id(8, 0), 0, 1, 0, '{"type":"system_warning_operation","value":{"message":"EAIGHT2 OPERATION"}}' :: jsonb :: hafd.operation )
    ;
...
BEGIN
    ASSERT NOT EXISTS (
        ...
        EXCEPT SELECT * FROM ( VALUES
                 ...
                 , ( 5, 5, 1, hafd.operation_id(5, 0), 1::SMALLINT )
                 , ( 6, 6, 1, hafd.operation_id(6, 0), 1::SMALLINT )
                 , ( 7, 7, 2, hafd.operation_id(7, 0), 1::SMALLINT )
                 , ( 8, 8, 2, hafd.operation_id(7, 1), 1::SMALLINT )
                 , ( 9, 9, 3, hafd.operation_id(7, 0), 1::SMALLINT )
                 ) as pattern
