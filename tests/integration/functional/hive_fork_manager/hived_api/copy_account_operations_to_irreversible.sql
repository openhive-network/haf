...
BEGIN
    ...
    VALUES
         ...
         , ( hafd.operation_id(6, 0), 0, 1, 0, '{"message":"SIX OPERATION"}'::jsonb )
         , ( hafd.operation_id(7, 0), 0, 1, 0, '{"message":"SEVEN2 OPERATION"}'::jsonb )
         , ( hafd.operation_id(7, 1), 0, 1, 1, '{"message":"SEVEN21 OPERATION"}'::jsonb )
         , ( hafd.operation_id(8, 0), 0, 1, 0, '{"message":"EAIGHT2 OPERATION"}'::jsonb )
    ;
