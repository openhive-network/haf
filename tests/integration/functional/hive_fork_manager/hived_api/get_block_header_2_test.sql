...
BEGIN
    ...
    VALUES
        ...
        , ( 9, '\xBADD90', '\xCAFE901234', '2016-06-22 19:10:31-07'::timestamp, 5, '\x40071234', E'[{"version":"1.26"}]', '\x21571234', 'STM65w', 1000, 1000, 1000000, 1000, 1000, 1000, 2000, 2000 )
        , ( 10, '\xBADD1A', '\xCAFE1A', '2016-06-22 19:10:32-07'::timestamp, 5, '\x4007', E'[]', '\x2157', 'STM65w', 1000, 1000, 1000000, 1000, 1000, 1000, 2000, 2000 )
    ;
    ...
    UPDATE hafd.hive_state SET consistent_block = 10;
END;
$BODY$
;
