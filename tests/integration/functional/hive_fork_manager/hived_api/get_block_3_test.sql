...
BEGIN
    ...
    VALUES
        ...
        , ( hafd.make_block_id(3, 0), 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"TWO OPERATION 00"}}' :: jsonb :: hafd.operation, hafd.operation_id(3, 1) )
        , ( hafd.make_block_id(3, 0), 0, 0, 1, '{"type":"system_warning_operation","value":{"message":"TWO OPERATION 01"}}' :: jsonb :: hafd.operation, hafd.operation_id(3, 2) )
        , ( hafd.make_block_id(3, 0), 1, 0, 0, '{"type":"system_warning_operation","value":{"message":"TWO OPERATION 10"}}' :: jsonb :: hafd.operation, hafd.operation_id(3, 3) )
        , ( hafd.make_block_id(3, 0), 1, 0, 1, '{"type":"system_warning_operation","value":{"message":"TWO OPERATION 11"}}' :: jsonb :: hafd.operation, hafd.operation_id(3, 4) )
