...
BEGIN
    ...
    VALUES
        ...
        , ( 3, 1::SMALLINT, '\xDEED31', 101, 100, '2016-06-22 19:10:23-07'::timestamp, '\xBEEF0003', NULL )
    ...
    VALUES
        ...
        , ( hafd.operation_id(3, 0), 0, 1, 0, '{"message":"TWO OPERATION 00"}'::jsonb )
        , ( hafd.operation_id(3, 1), 0, 1, 1, '{"message":"TWO OPERATION 01"}'::jsonb )
        , ( hafd.operation_id(3, 2), 1, 1, 2, '{"message":"TWO OPERATION 10"}'::jsonb )
        , ( hafd.operation_id(3, 3), 1, 1, 3, '{"message":"TWO OPERATION 11"}'::jsonb )
