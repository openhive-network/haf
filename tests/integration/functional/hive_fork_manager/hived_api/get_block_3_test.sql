...
BEGIN
    ...
    VALUES
        ...
        , ( hafd.make_block_id(3, 0), 0, 0, '{"type":"system_warning_operation","value":{"message":"TWO OPERATION 00"}}' :: jsonb :: hafd.operation, hafd.operation_id(hafd.make_block_id(3, 0), 1, 0::SMALLINT) )
        , ( hafd.make_block_id(3, 0), 0, 1, '{"type":"system_warning_operation","value":{"message":"TWO OPERATION 01"}}' :: jsonb :: hafd.operation, hafd.operation_id(hafd.make_block_id(3, 0), 2, 1::SMALLINT) )
        , ( hafd.make_block_id(3, 0), 1, 0, '{"type":"system_warning_operation","value":{"message":"TWO OPERATION 10"}}' :: jsonb :: hafd.operation, hafd.operation_id(hafd.make_block_id(3, 0), 3, 2::SMALLINT) )
        , ( hafd.make_block_id(3, 0), 1, 1, '{"type":"system_warning_operation","value":{"message":"TWO OPERATION 11"}}' :: jsonb :: hafd.operation, hafd.operation_id(hafd.make_block_id(3, 0), 4, 2::SMALLINT) )
