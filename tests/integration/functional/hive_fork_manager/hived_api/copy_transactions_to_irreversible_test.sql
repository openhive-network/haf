...
BEGIN
    ...
    VALUES
         ...
         , ( 8, 0::SMALLINT, '\xDEED88', 101, 100, '2016-06-22 19:10:28-07'::timestamp, '\xBEEF', 88,  3 )
...
BEGIN
    ASSERT NOT EXISTS (
        ...
        EXCEPT SELECT * FROM ( VALUES
                 ...
                 , ( 8, 0::SMALLINT, '\xDEED88'::bytea, 101, 100, '2016-06-22 19:10:28-07'::timestamp, '\xBEEF'::bytea, 88::BIGINT )
                 ) as pattern
