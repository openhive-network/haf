...
$BODY$
BEGIN
    ASSERT ( SELECT COUNT(*) FROM hive_data.blocks ) = 2, 'Unexpected number of blocks';
    ASSERT ( SELECT COUNT(*) FROM hive_data.transactions ) = 2, 'Unexpected number of transactions';
    ASSERT ( SELECT COUNT(*) FROM hive_data.transactions_multisig ) = 2, 'Unexpected number of signatures';
    ASSERT ( SELECT COUNT(*) FROM hive_data.operations ) = 2, 'Unexpected number of operations';
    ASSERT ( SELECT COUNT(*) FROM hive_data.accounts ) = 5, 'Unexpected number of accounts';
    ASSERT ( SELECT COUNT(*) FROM hive_data.account_operations ) = 2, 'Unexpected number of account_operations';
    ASSERT ( SELECT COUNT(*) FROM hive_data.applied_hardforks ) = 2, 'Unexpected number of applied_hardforks';
END
$BODY$
;
