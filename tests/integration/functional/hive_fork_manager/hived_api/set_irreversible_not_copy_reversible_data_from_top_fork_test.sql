...
BEGIN
    ...
    VALUES
    ( hive.operation_id(2,1,0), 0, 0, '2016-06-22 19:10:21-07'::timestamp, '{"type":"system_warning_operation","value":{"message":"THREE OPERATION"}}' :: jsonb :: hive.operation, 2 )
    ;
    ...
    VALUES ( 1, 2, hive.operation_id(2,1,0), 2 )
    ;
