...
BEGIN
    ...
    VALUES
        ...
        , ( 6, 0, 0, 1, 0, '{"type":"system_warning_operation","value":{"message":"SIX0 OPERATION"}}' :: jsonb :: hafd.operation )
        , ( 7, 0, 0, 1, 0, '{"type":"system_warning_operation","value":{"message":"SEVEN OPERATION"}}' :: jsonb :: hafd.operation )
        , ( 7, 1, 0, 1, 0, '{"type":"system_warning_operation","value":{"message":"SEVEN OPERATION"}}' :: jsonb :: hafd.operation )
        , ( 8, 0, 0, 1, 0, '{"type":"system_warning_operation","value":{"message":"EIGHT0 OPERATION"}}' :: jsonb :: hafd.operation )
        , ( 9, 0, 0, 1, 0, '{"type":"system_warning_operation","value":{"message":"NINE0 OPERATION"}}' :: jsonb :: hafd.operation )
        , ( 10, 0, 0, 1, 0, '{"type":"system_warning_operation","value":{"message":"TEN0 OPERATION"}}' :: jsonb :: hafd.operation )
    ;
