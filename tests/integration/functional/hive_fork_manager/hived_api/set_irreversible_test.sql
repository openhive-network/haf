...
BEGIN
    ...
    VALUES
          ( hafd.make_block_id(1, 0), hafd.operation_id(1, 1), 1, 1, 1, 0 )
        , ( hafd.make_block_id(2, 0), hafd.operation_id(2, 1), 1, 1, 2, 0 )
        , ( hafd.make_block_id(2, 0), hafd.operation_id(2, 1), 2, 2, 1, 0 )
        , ( hafd.make_block_id(3, 0), hafd.operation_id(3, 1), 3, 3, 1, 0 )
        , ( hafd.make_block_id(4, 0), hafd.operation_id(4, 1), 4, 4, 1, 0 )
    ;
    ...
    INSERT INTO hafd.operations(block_id, trx_in_block, op_type_id, op_pos, body_binary, id)
    VALUES
          ( hafd.make_block_id(6, 1), 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"SIX1 OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(6, 1) )
        ...
        , ( hafd.make_block_id(8, 1), 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"EIGHT1 OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(8, 1) )
        , ( hafd.make_block_id(9, 1), 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"NINE1 OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(9, 1) )
    ;

    INSERT INTO hafd.account_operations(block_id, operation_id, account_id, transacting_account_id, account_op_seq_no, op_type_id)
    VALUES
          ( hafd.make_block_id(6, 1), hafd.operation_id(6, 1), 6, 6, 1, 0 )
    ;
    ...
    INSERT INTO hafd.account_operations(block_id, operation_id, account_id, transacting_account_id, account_op_seq_no, op_type_id)
    VALUES
          ( hafd.make_block_id(7, 2), hafd.operation_id(7, 1), 4, 4, 2, 0 )
        , ( hafd.make_block_id(7, 2), hafd.operation_id(7, 1), 7, 7, 1, 0 )
    ;
