...
BEGIN
    ...
    VALUES
           ( hafd.make_block_id(1, 0), 0, 1, 0, '{"type":"system_warning_operation","value":{"message":"ZERO OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(1, 1) )
         , ( hafd.make_block_id(2, 0), 0, 1, 0, '{"type":"system_warning_operation","value":{"message":"ONE OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(2, 1) )
    ;
    ...
    VALUES
          ( 1, 1, 1, hafd.make_block_id(1, 0), hafd.operation_id(1, 1), 1 )
        , ( 2, 2, 1, hafd.make_block_id(2, 0), hafd.operation_id(2, 1), 1 )
    ;
