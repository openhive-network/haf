...
BEGIN
    ...
    ASSERT EXISTS(
        SELECT * FROM hafd.indexes_constraints WHERE table_name='hafd.operations' AND index_constraint_name = 'pk_hive_operations' AND is_constraint = TRUE
    ), 'No hafd.operations PK pk_hive_operations';
