...
BEGIN
    ...
    ASSERT NOT ( SELECT is_any_index_for_table( 'hive.irreversible_data_renamed'::regclass::oid ) ) , 'Index hive.irreversible_data_renamed exists';
    ...
    ASSERT NOT ( SELECT is_any_fk_for_hive_table( 'irreversible_data_renamed') ), 'FK for hive.irreversible_data_renamed exists';
