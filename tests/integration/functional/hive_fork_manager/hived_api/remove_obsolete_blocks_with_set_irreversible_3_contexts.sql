...
BEGIN
    ...
    VALUES
         ...
         , ( 5, 5, 1, 5, 0, 1, 1 )
         , ( 6, 6, 1, 6, 0, 1, 1 )
         , ( 7, 7, 1, 7, 0, 1, 1 ) -- must be overriden by fork 2
         , ( 8, 8, 1, 7, 1, 1, 1 ) -- must be overriden by fork 2
         , ( 9, 9, 1, 7, 2, 1, 1 ) -- must be overriden by fork 2
         , ( 7, 7, 2, 7, 0, 1, 2 )
         , ( 8, 8, 2, 7, 1, 1, 2 ) -- will be abandoned since fork 3 doesn not have this account operation
         , ( 9, 9, 2, 8, 0, 1, 2 )
         , ( 9, 9, 3, 7, 0, 1, 2 )
         , ( 10, 10, 2, 9, 0, 1, 2 )
         , ( 9, 9, 3, 8, 0, 1, 3 )
    ...
    VALUES
         ...
         , ( 5, 5, 5, 0, 1 )
         , ( 6, 6, 6, 0, 1 )
         , ( 7, 7, 7, 0, 1 ) -- must be abandon because of fork2
         , ( 8, 7, 7, 1, 1 ) -- must be abandon because of fork2
         , ( 9, 7, 7, 2, 1 ) -- must be abandon because of fork2
         , ( 7, 7, 7, 0, 2 )
         , ( 8, 7, 7, 1, 2 )
         , ( 9, 8, 8, 0, 2 )
         , ( 10, 9, 9, 0, 2 )
...
BEGIN
    ...
    ASSERT NOT EXISTS (
    SELECT block_num, op_pos_in_block, trx_in_block, op_type_id, op_pos, body_binary, fork_id FROM hafd.operations_reversible
    EXCEPT SELECT * FROM ( VALUES
           ( 7, 0, 0, 1::SMALLINT, 0, '{"type":"system_warning_operation","value":{"message":"SEVEN0 OPERATION"}}' :: jsonb :: hafd.operation, 1 )
         , ( 7, 1, 0, 1::SMALLINT, 1, '{"type":"system_warning_operation","value":{"message":"SEVEN01 OPERATION"}}' :: jsonb :: hafd.operation, 1 )
         , ( 7, 2, 0, 1::SMALLINT, 2, '{"type":"system_warning_operation","value":{"message":"SEVEN02 OPERATION"}}' :: jsonb :: hafd.operation, 1 )
         , ( 7, 0, 0, 1::SMALLINT, 0, '{"type":"system_warning_operation","value":{"message":"SEVEN2 OPERATION"}}' :: jsonb :: hafd.operation, 2 )
         , ( 7, 1, 0, 1::SMALLINT, 1, '{"type":"system_warning_operation","value":{"message":"SEVEN21 OPERATION"}}' :: jsonb :: hafd.operation, 2 )
         , ( 8, 0, 0, 1::SMALLINT, 0, '{"type":"system_warning_operation","value":{"message":"EAIGHT2 OPERATION"}}' :: jsonb :: hafd.operation, 2 )
         , ( 9, 0, 0, 1::SMALLINT, 0, '{"type":"system_warning_operation","value":{"message":"NINE2 OPERATION"}}' :: jsonb :: hafd.operation, 2 )
         , ( 8, 0, 0, 1::SMALLINT, 0, '{"type":"system_warning_operation","value":{"message":"EIGHT3 OPERATION"}}' :: jsonb :: hafd.operation, 3 )
         , ( 9, 0, 0, 1::SMALLINT, 0, '{"type":"system_warning_operation","value":{"message":"NINE3 OPERATION"}}' :: jsonb :: hafd.operation, 3 )
         , ( 10, 0, 0, 1::SMALLINT, 0, '{"type":"system_warning_operation","value":{"message":"TEN OPERATION"}}' :: jsonb :: hafd.operation, 3 )
    ) as pattern
    ...
    EXCEPT SELECT * FROM ( VALUES
               ( 7, 7, 1, 7, 0, 1::SMALLINT, 1::BIGINT )
             , ( 8, 8, 1, 7, 1, 1::SMALLINT, 1::BIGINT )
             , ( 9, 9, 1, 7, 2, 1::SMALLINT, 1::BIGINT )
             , ( 7, 7, 2, 7, 0, 1::SMALLINT, 2::BIGINT )
             , ( 8, 8, 2, 7, 1, 1::SMALLINT, 2::BIGINT )
             , ( 9, 9, 2, 8, 0, 1::SMALLINT, 2::BIGINT )
             , ( 9, 9, 3, 7, 0, 1::SMALLINT, 2::BIGINT )
             , ( 10, 10, 2, 9, 0, 1::SMALLINT, 2::BIGINT )
             , ( 9, 9, 3, 8, 0, 1::SMALLINT, 3::BIGINT )
             , ( 10, 10, 3, 9, 0, 1::SMALLINT, 3::BIGINT )
             , ( 11, 11, 3, 10, 0, 1::SMALLINT, 3::BIGINT )
        ) as pattern
