...
BEGIN
    ...
    VALUES
           ( 4, 0::SMALLINT, '\xDEED40', 101, 100, '2016-06-22 19:10:24-07'::timestamp, '\xBEEF', NULL,  1 )
         , ( 5, 0::SMALLINT, '\xDEED55', 101, 100, '2016-06-22 19:10:25-07'::timestamp, '\xBEEF', NULL,  1 )
         , ( 6, 0::SMALLINT, '\xDEED60', 101, 100, '2016-06-22 19:10:26-07'::timestamp, '\xBEEF', NULL,  1 )
         , ( 7, 0::SMALLINT, '\xDEED70', 101, 100, '2016-06-22 19:10:37-07'::timestamp, '\xBEEF', NULL,  1 )
         , ( 10, 0::SMALLINT, '\xDEED11', 101, 100, '2016-06-22 19:10:41-07'::timestamp, '\xBEEF', NULL,  1 )
         , ( 7, 0::SMALLINT, '\xDEED70', 101, 100, '2016-06-22 19:10:27-07'::timestamp, '\xBEEF', NULL,  2 )
         , ( 8, 0::SMALLINT, '\xDEED80', 101, 100, '2016-06-22 19:10:28-07'::timestamp, '\xBEEF', NULL,  2 )
         , ( 9, 0::SMALLINT, '\xDEED90', 101, 100, '2016-06-22 19:10:29-07'::timestamp, '\xBEEF', NULL,  2 )
         , ( 8, 0::SMALLINT, '\xDEED88', 101, 100, '2016-06-22 19:10:28-07'::timestamp, '\xBEEF', NULL,  3 )
         , ( 9, 0::SMALLINT, '\xDEED99', 101, 100, '2016-06-22 19:10:29-07'::timestamp, '\xBEEF', NULL,  3 )
         , ( 10, 0::SMALLINT, '\xDEED1102', 101, 100, '2016-06-22 19:10:30-07'::timestamp, '\xBEEF', NULL, 3 )
    ;
...
BEGIN
    ...
    ASSERT NOT EXISTS (
        ...
        EXCEPT SELECT * FROM ( VALUES
           ( 7, 0::SMALLINT, '\xDEED70'::bytea, 101, 100, '2016-06-22 19:10:37-07'::timestamp, '\xBEEF'::bytea, NULL::BIGINT,  1 )
         , ( 10, 0::SMALLINT, '\xDEED11'::bytea, 101, 100, '2016-06-22 19:10:41-07'::timestamp, '\xBEEF'::bytea, NULL::BIGINT,  1 )
         , ( 7, 0::SMALLINT, '\xDEED70'::bytea, 101, 100, '2016-06-22 19:10:27-07'::timestamp, '\xBEEF'::bytea, NULL::BIGINT,  2 )
         , ( 8, 0::SMALLINT, '\xDEED80'::bytea, 101, 100, '2016-06-22 19:10:28-07'::timestamp, '\xBEEF'::bytea, NULL::BIGINT,  2 )
         , ( 9, 0::SMALLINT, '\xDEED90'::bytea, 101, 100, '2016-06-22 19:10:29-07'::timestamp, '\xBEEF'::bytea, NULL::BIGINT,  2 )
         , ( 8, 0::SMALLINT, '\xDEED88'::bytea, 101, 100, '2016-06-22 19:10:28-07'::timestamp, '\xBEEF'::bytea, NULL::BIGINT,  3 )
         , ( 9, 0::SMALLINT, '\xDEED99'::bytea, 101, 100, '2016-06-22 19:10:29-07'::timestamp, '\xBEEF'::bytea, NULL::BIGINT,  3 )
         , ( 10, 0::SMALLINT, '\xDEED1102'::bytea, 101, 100, '2016-06-22 19:10:30-07'::timestamp, '\xBEEF'::bytea, NULL::BIGINT, 3 )
        ) as pattern
    ...
    EXCEPT SELECT * FROM ( VALUES
           ( hafd.operation_id(7, 0), 0, 1::SMALLINT, 0, '{"message":"SEVEN0 OPERATION"}'::jsonb, 1 )
         , ( hafd.operation_id(7, 1), 0, 1::SMALLINT, 1, '{"message":"SEVEN01 OPERATION"}'::jsonb, 1 )
         , ( hafd.operation_id(7, 2), 0, 1::SMALLINT, 2, '{"message":"SEVEN02 OPERATION"}'::jsonb, 1 )
    ...
    ASSERT NOT EXISTS (
        ...
        EXCEPT SELECT * FROM ( VALUES
       ( 7, 7, hafd.operation_id(7, 0), 1 )
     , ( 8, 7, hafd.operation_id(7, 1), 1 )
     , ( 9, 7, hafd.operation_id(7, 2), 1 )
     , ( 7, 7, hafd.operation_id(7, 0), 2 )
     , ( 8, 7, hafd.operation_id(7, 1), 2 )
     , ( 9, 8, hafd.operation_id(8, 0), 2 )
     , ( 10, 9, hafd.operation_id(9, 0), 2 )
    ...
    EXCEPT SELECT * FROM ( VALUES
               ( 7, 7, 1, hafd.operation_id(7, 0), 1::SMALLINT, 1::BIGINT )
             , ( 8, 8, 1, hafd.operation_id(7, 1), 1::SMALLINT, 1::BIGINT )
             , ( 9, 9, 1, hafd.operation_id(7, 2), 1::SMALLINT, 1::BIGINT )
             , ( 7, 7, 2, hafd.operation_id(7, 0), 1::SMALLINT, 2::BIGINT )
             , ( 8, 8, 2, hafd.operation_id(7, 1), 1::SMALLINT, 2::BIGINT )
             , ( 9, 9, 2, hafd.operation_id(8, 0), 1::SMALLINT, 2::BIGINT )
             , ( 9, 9, 3, hafd.operation_id(7, 0), 1::SMALLINT, 2::BIGINT )
             , ( 10, 10, 2, hafd.operation_id(9, 0), 1::SMALLINT, 2::BIGINT )
             , ( 9, 9, 3, hafd.operation_id(8, 0), 1::SMALLINT, 3::BIGINT )
