...
BEGIN
    ...
    ASSERT NOT EXISTS (
        ...
        EXCEPT SELECT * FROM ( VALUES
       ( 7, 7, hafd.operation_id(7,1,0), 1 )
     , ( 8, 7, hafd.operation_id(7,1,1), 1 )
     , ( 9, 7, hafd.operation_id(7,1,2), 1 )
     , ( 7, 7, hafd.operation_id(7,1,0), 2 )
     , ( 8, 7, hafd.operation_id(7,1,1), 2 )
     , ( 9, 8, hafd.operation_id(8,1,0), 2 )
     , ( 10, 9, hafd.operation_id(9,1,0), 2 )
    ...
    EXCEPT SELECT * FROM ( VALUES
               ( 7, 7, 1, hafd.operation_id(7,1,0), 1 )
             , ( 8, 8, 1, hafd.operation_id(7,1,1), 1 )
             , ( 9, 9, 1, hafd.operation_id(7,1,2), 1 )
             , ( 7, 7, 2, hafd.operation_id(7,1,0), 2 )
