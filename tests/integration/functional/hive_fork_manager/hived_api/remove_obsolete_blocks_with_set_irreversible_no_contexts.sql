...
BEGIN
    ...
    ASSERT NOT EXISTS (
        ...
        EXCEPT SELECT * FROM ( VALUES
           ( 10, 0::SMALLINT, '\xDEED11', 101, 100, '2016-06-22 19:10:41-07'::timestamp, '\xBEEF', NULL::BIGINT,  1 )
         , ( 8, 0::SMALLINT, '\xDEED80', 101, 100, '2016-06-22 19:10:28-07'::timestamp, '\xBEEF', NULL::BIGINT,  2 )
         , ( 9, 0::SMALLINT, '\xDEED90', 101, 100, '2016-06-22 19:10:29-07'::timestamp, '\xBEEF', NULL::BIGINT,  2 )
