...
DECLARE
    __fork_id INT;
    __context_stages hive_data.application_stages := ARRAY[ ('stage1',1 ,100 )::hive_data.application_stage, hive_data.live_stage() ];
BEGIN
...
BEGIN
    SELECT fork_id INTO __context_fork_id FROM hive_data.contexts WHERE name = 'context'; --(1,3)
