...
$BODY$
DECLARE
    __stages_correct hive_data.application_stages := ARRAY[ ('stage2',100 ,100 )::hive.application_stage, ('stage1',10 ,10 )::hive.application_stage, hive.live_stage() ];
    __stages_repeated_names hive_data.application_stages := ARRAY[ ('live',1 ,1 )::hive.application_stage, hive.live_stage() ];
