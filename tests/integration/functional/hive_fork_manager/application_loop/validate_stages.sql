...
$BODY$
DECLARE
    __stages_correct hafd.application_stages := ARRAY[ hive.stage('stage2',100 ,100 ), hive.stage('stage1',10 ,10 ), hafd.live_stage() ];
    __stages_repeated_names hafd.application_stages := ARRAY[ hive.stage('live',1 ,1 ), hafd.live_stage() ];
    __stages_repeated_hb_distance hafd.application_stages :=
        ARRAY[
            hive.stage('live1',1 ,1 ),
            hive.stage('live2',1 ,2 ),
            hafd.live_stage()
        ];
