...
$BODY$
DECLARE
    __context_stages hafd.application_stages := ARRAY[ hafd.custom_stage('stage1',3 ,3 ), hafd.live_stage() ];
    __context_b_stages hafd.application_stages := ARRAY[ hafd.custom_stage('stage1',3 ,3 ), hafd.live_stage() ];
BEGIN
