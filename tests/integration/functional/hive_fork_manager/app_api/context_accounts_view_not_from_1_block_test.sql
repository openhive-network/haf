...
VALUES
    ...
    , ( hafd.make_block_id(5, 1), '\xBADD50', '\xCAFE50', '2016-06-22 19:10:55-07'::timestamp, 100, '\x4007', E'[]', '\x2157', 'STM65w', 1000, 1000, 1000000, 1000, 1000, 1000, 2000, 2000 )
...
VALUES
       ( 100, 'alice1', hafd.make_block_id(2, 0) )
...
( 4, 'alice41', hafd.make_block_id(4, 1) )
     ...
     , ( 900, 'alice82', hafd.make_block_id(8, 2) )
