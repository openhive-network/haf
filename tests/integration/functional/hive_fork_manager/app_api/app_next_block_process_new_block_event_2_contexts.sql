...
BEGIN
    ...
    -- create a table to test forking app
    CREATE TABLE table2( id INT) INHERITS( b.context2 );
END;
$BODY$
;
...
BEGIN
    -- Both contexts start at current_block_num=0, irreversible_block=2.
    ...
    ASSERT __first_blocks_2.first_block = 1 AND __first_blocks_2.last_block = 2, 'Wrong first block context2';
...
BEGIN
    ...
    -- Events: 0:NEW_IRREVERSIBLE(0), 1:MASSIVE_SYNC(1), 2:NEW_IRREVERSIBLE(2), unreachable sentinel
