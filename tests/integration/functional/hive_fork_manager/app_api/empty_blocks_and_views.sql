...
BEGIN
    ...
    VALUES
        ( 2, 0, 0, 1, 0, '{"type":"system_warning_operation","value":{"message":"ONE OPERATION"}}' :: jsonb :: hafd.operation, 2 )
    ;
...
BEGIN
    ...
    ASSERT NOT EXISTS (
        ...
        EXCEPT SELECT o.block_num, o.op_pos_in_block, o.trx_in_block, o.op_pos, o.body_binary, o.body FROM a.operations_view o
