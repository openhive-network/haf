...
BEGIN
    CREATE SCHEMA A;
    PERFORM hive.app_create_context( 'attached_context', _schema => 'a' );
    PERFORM hive.app_create_context( 'attached_context_not_insync', _schema => 'a' );
    PERFORM hive.app_create_context( 'detached_context', _schema => 'a' );
