...
BEGIN
    ...
    INSERT INTO hafd.operations
      (block_id, seq_in_block, trx_in_block, op_pos, op_type_id, body_binary)
    VALUES
        ...
        , ( hafd.make_block_id(3, 0), 1, 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"TWO OPERATION"}}' :: jsonb :: hafd.operation )
    ...
    VALUES
           ( hafd.make_block_id(4, 1), 1, 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"THREE OPERATION"}}' :: jsonb :: hafd.operation )
         , ( hafd.make_block_id(5, 1), 1, 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"FIVEFIVE OPERATION"}}' :: jsonb :: hafd.operation )
         , ( hafd.make_block_id(6, 1), 1, 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"SIX OPERATION"}}' :: jsonb :: hafd.operation )
         , ( hafd.make_block_id(7, 1), 1, 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"SEVEN0 OPERATION"}}' :: jsonb :: hafd.operation ) -- must be abandon because of fork2
         , ( hafd.make_block_id(7, 1), 2, 0, 1, 0, '{"type":"system_warning_operation","value":{"message":"SEVEN01 OPERATION"}}' :: jsonb :: hafd.operation ) -- must be abandon because of fork2
         , ( hafd.make_block_id(7, 1), 3, 0, 2, 0, '{"type":"system_warning_operation","value":{"message":"SEVEN02 OPERATION"}}' :: jsonb :: hafd.operation ) -- must be abandon because of fork2
         , ( hafd.make_block_id(7, 2), 1, 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"SEVEN2 OPERATION"}}' :: jsonb :: hafd.operation )
         , ( hafd.make_block_id(7, 2), 2, 0, 1, 0, '{"type":"system_warning_operation","value":{"message":"SEVEN21 OPERATION"}}' :: jsonb :: hafd.operation )
         , ( hafd.make_block_id(8, 2), 1, 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"EAIGHT2 OPERATION"}}' :: jsonb :: hafd.operation )
         , ( hafd.make_block_id(9, 2), 1, 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"NINE2 OPERATION"}}' :: jsonb :: hafd.operation )
         , ( hafd.make_block_id(8, 3), 1, 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"EIGHT3 OPERATION"}}' :: jsonb :: hafd.operation )
         , ( hafd.make_block_id(9, 3), 1, 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"NINE3 OPERATION"}}' :: jsonb :: hafd.operation )
         , ( hafd.make_block_id(10, 3), 1, 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"TEN OPERATION"}}' :: jsonb :: hafd.operation )
    ;
