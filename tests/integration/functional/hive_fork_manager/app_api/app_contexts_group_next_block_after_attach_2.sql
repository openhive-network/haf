...
BEGIN
    ...
    VALUES
        ( hafd.make_block_id(5, 0), 1, 0, 0, 1, '{"type":"account_create_operation","value":{"fee":{"amount":"0","precision":3,"nai":"@@000000021"},"creator":"initminer","new_account_name":"account_5","owner":{"weight_threshold":1,"account_auths":[],"key_auths":[]},"active":{"weight_threshold":1,"account_auths":[],"key_auths":[]},"posting":{"weight_threshold":1,"account_auths":[],"key_auths":[]},"memo_key":"STM7tjB4CNqUD5kbTHdrJUaHE76xicHMQdpD5N32a7wTr1qnSmG1V","json_metadata":"{}"}}' :: jsonb :: hafd.operation, hafd.operation_id(hafd.make_block_id(5, 0), 1, 1::SMALLINT) );
    ...
    INSERT INTO hafd.operations (block_id, seq_in_block, trx_in_block, op_pos, op_type_id, body_binary, id)
    VALUES
        ( hafd.make_block_id(8, 1), 1, 0, 0, 1, '{"type":"account_create_operation","value":{"fee":{"amount":"0","precision":3,"nai":"@@000000021"},"creator":"initminer","new_account_name":"account_8_rev","owner":{"weight_threshold":1,"account_auths":[],"key_auths":[]},"active":{"weight_threshold":1,"account_auths":[],"key_auths":[]},"posting":{"weight_threshold":1,"account_auths":[],"key_auths":[]},"memo_key":"STM7tjB4CNqUD5kbTHdrJUaHE76xicHMQdpD5N32a7wTr1qnSmG1V","json_metadata":"{}"}}' :: jsonb :: hafd.operation, hafd.operation_id(hafd.make_block_id(8, 1), 1, 1::SMALLINT) );
    ...
    INSERT INTO hafd.operations (block_id, seq_in_block, trx_in_block, op_pos, op_type_id, body_binary, id)
    VALUES
        ( hafd.make_block_id(8, 2), 1, 0, 0, 1, '{"type":"account_create_operation","value":{"fee":{"amount":"0","precision":3,"nai":"@@000000021"},"creator":"initminer","new_account_name":"account_8","owner":{"weight_threshold":1,"account_auths":[],"key_auths":[]},"active":{"weight_threshold":1,"account_auths":[],"key_auths":[]},"posting":{"weight_threshold":1,"account_auths":[],"key_auths":[]},"memo_key":"STM7tjB4CNqUD5kbTHdrJUaHE76xicHMQdpD5N32a7wTr1qnSmG1V","json_metadata":"{}"}}' :: jsonb :: hafd.operation, hafd.operation_id(hafd.make_block_id(8, 2), 1, 1::SMALLINT) );
...
BEGIN
    PERFORM hive.app_set_current_block_num( ARRAY[ 'context_b', 'context' ], 6 );
    CALL hive.appproc_context_attach( ARRAY[ 'context_b', 'context' ] );
END
$BODY$
;
