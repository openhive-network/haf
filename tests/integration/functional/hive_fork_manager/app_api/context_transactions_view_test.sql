...
BEGIN
    ...
    VALUES
         ...
         , ( hafd.make_block_id(7, 1), 0::SMALLINT, '\xDEED70F0', 101, 100, '2016-06-22 19:10:27-07'::timestamp, '\xBEEF' ) -- should be abandon because of fork 2
         , ( hafd.make_block_id(7, 1), 1::SMALLINT, '\xDEED70F1', 101, 100, '2016-06-22 19:10:27-07'::timestamp, '\xBEEF' ) -- should be abandon because of fork 2
         , ( hafd.make_block_id(7, 1), 2::SMALLINT, '\xDEED70F2', 101, 100, '2016-06-22 19:10:27-07'::timestamp, '\xBEEF' ) -- should be abandon because of fork 2
         , ( hafd.make_block_id(7, 2), 0::SMALLINT, '\xDEED70', 101, 100, '2016-06-22 19:10:27-07'::timestamp, '\xBEEF' )
         , ( hafd.make_block_id(7, 2), 1::SMALLINT, '\xDEED70B1', 101, 100, '2016-06-22 19:10:27-07'::timestamp, '\xBEEF' )
...
BEGIN
    ...
    ASSERT NOT EXISTS (
        ...
        EXCEPT SELECT * FROM ( VALUES
                 ...
                 , ( 5, 0::SMALLINT, '\xDEED55'::bytea, 101, 100, '2016-06-22 19:10:25-07'::timestamp, '\xBEEF'::bytea )
                 ...
                 , ( 8, 0::SMALLINT, '\xDEED80'::bytea, 101, 100, '2016-06-22 19:10:28-07'::timestamp, '\xBEEF'::bytea )
                 ) as pattern
