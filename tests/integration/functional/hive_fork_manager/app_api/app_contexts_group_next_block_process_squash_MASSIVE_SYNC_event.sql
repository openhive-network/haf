...
BEGIN
    ...
    PERFORM test.create_blocks(3, 6);
...
BEGIN
    ...
    ASSERT ( SELECT events_id FROM hafd.contexts WHERE name='context_b' LIMIT 1 ) = 4, 'Wrong events id 4 b';
    ...
    ASSERT ( SELECT events_id FROM hafd.contexts WHERE name='context_b' LIMIT 1 ) = 7, 'Wrong events id 7 b'; -- MASSIVE_SYNC_EVENTS squashed

    ASSERT ( SELECT current_block_num FROM hafd.contexts WHERE name='context' ) = 4, 'Wrong current block num 3';
    ASSERT ( SELECT current_block_num FROM hafd.contexts WHERE name='context_b' ) = 4, 'Wrong current block num 3b';
    ASSERT ( SELECT events_id FROM hafd.contexts WHERE name='context' ) = 7, 'Wrong events id 7';
    ASSERT ( SELECT events_id FROM hafd.contexts WHERE name='context_b' ) = 7, 'Wrong events id 7 b';
