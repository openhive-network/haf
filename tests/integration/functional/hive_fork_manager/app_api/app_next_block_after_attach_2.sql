...
BEGIN
    ...
    VALUES
        ( 1, 5, 0, 0, 1, '2016-06-22 19:10:21-07'::timestamp, ('account_5', 'initminer', NULL, NULL) :: hive.account_created_operation );
    ...
    VALUES
        ( 2, 8, 0, 0, 1, '2016-06-22 19:10:21-07'::timestamp, ('account_8_reversible', 'initminer', NULL, NULL) :: hive.account_created_operation, 1 );
    ...
    INSERT INTO hive.operations_reversible
    VALUES
        ( 2, 8, 0, 0, 1, '2016-06-22 19:10:21-07'::timestamp, ('account_8', 'initminer', NULL, NULL) :: hive.account_created_operation, 2 );
