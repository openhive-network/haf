...
BEGIN
    ...
    ASSERT NOT EXISTS (
        ...
        EXCEPT SELECT * FROM ( VALUES
              ( 1,  100, 100, 1, hafd.operation_id(hafd.make_block_id(1, 0), 0, 1::SMALLINT), 1 )
            , ( 2,  100, 100, 2, hafd.operation_id(hafd.make_block_id(2, 0), 0, 1::SMALLINT), 1 )
            , ( 2,  200, 200, 1, hafd.operation_id(hafd.make_block_id(2, 0), 0, 1::SMALLINT), 1 )
            , ( 3,  300, 300, 1, hafd.operation_id(hafd.make_block_id(3, 0), 0, 1::SMALLINT), 1 )
            , ( 4,  400, 400, 1, hafd.operation_id(hafd.make_block_id(4, 1), 0, 1::SMALLINT), 1 )
            , ( 5,  500, 500, 1, hafd.operation_id(hafd.make_block_id(5, 1), 0, 1::SMALLINT), 1 )
            , ( 6,  600, 600, 1, hafd.operation_id(hafd.make_block_id(6, 1), 0, 1::SMALLINT), 1 )
            , ( 7,  700, 700, 2, hafd.operation_id(hafd.make_block_id(7, 2), 0, 1::SMALLINT), 1 )
            , ( 7,  800, 800, 2, hafd.operation_id(hafd.make_block_id(7, 2), 1, 1::SMALLINT), 1 )
            , ( 9,  900, 900, 3, hafd.operation_id(hafd.make_block_id(9, 3), 0, 1::SMALLINT), 1 )
            , (10,  100, 100, 3, hafd.operation_id(hafd.make_block_id(10, 3), 0, 1::SMALLINT), 1 )
            , (10, 1100, 1100, 3, hafd.operation_id(hafd.make_block_id(10, 3), 0, 1::SMALLINT), 1 )
        ) as pattern
    ...
    ASSERT NOT EXISTS (
        ...
        EXCEPT SELECT * FROM ( VALUES
                                ...
                                , ( 2, 200, 200, 1, hafd.operation_id(hafd.make_block_id(2, 0), 0, 1::SMALLINT), 1 )
                                , ( 3, 300, 300, 1, hafd.operation_id(hafd.make_block_id(3, 0), 0, 1::SMALLINT), 1 )
                                , ( 4, 400, 400, 1, hafd.operation_id(hafd.make_block_id(4, 0), 0, 1::SMALLINT), 1 )
                             ) as pattern
