...
BEGIN
    ...
    VALUES
         ...
         , ( 500, 500, 1, 5, 0, 1, 1 )
         , ( 600, 600, 1, 6, 0, 1, 1 )
         , ( 700, 700, 1, 7, 0, 1, 1 ) -- must be overriden by fork 2
         , ( 800, 800, 1, 7, 1, 1, 1 ) -- must be overriden by fork 2
         , ( 900, 900, 1, 7, 2, 1, 1 ) -- must be overriden by fork 2
         , ( 700, 700, 2, 7, 0, 1, 2 )
         , ( 800, 800, 2, 7, 1, 1, 2 ) -- will be abandoned since fork 3 doesn not have this account operation
         , ( 900, 900, 2, 8, 0, 1, 2 )
         , ( 900, 900, 3, 7, 0, 1, 2 )
         , ( 1000, 1000, 2, 9, 0, 1, 2 )
         , ( 900, 900, 3, 9, 0, 1, 3 )
         , ( 100, 100, 3, 10, 0, 1, 3 )
         , ( 1100, 1100, 3, 10, 0, 1, 3 )
    ;
