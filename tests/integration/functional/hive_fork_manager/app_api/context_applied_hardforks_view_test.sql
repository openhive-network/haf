...
BEGIN
    ...
    VALUES
           ( hafd.make_block_id(1, 0), 0, 0, 0, 1, '{"type":"system_warning_operation","value":{"message":"ZERO OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(1, 0, 1) )
         , ( hafd.make_block_id(2, 0), 0, 0, 0, 1, '{"type":"system_warning_operation","value":{"message":"ONE OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(2, 0, 1) )
         , ( hafd.make_block_id(3, 0), 0, 0, 0, 1, '{"type":"system_warning_operation","value":{"message":"TWO OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(3, 0, 1) )
         , ( hafd.make_block_id(4, 0), 0, 0, 0, 1, '{"type":"system_warning_operation","value":{"message":"THREE OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(4, 0, 1) )
         , ( hafd.make_block_id(5, 0), 0, 0, 0, 1, '{"type":"system_warning_operation","value":{"message":"FIVE OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(5, 0, 1) )
    ;

    INSERT INTO hafd.operations (block_id, seq_in_block, trx_in_block, op_pos, op_type_id, body_binary, id)
    VALUES
           ( hafd.make_block_id(4, 1), 0, 0, 0, 1, '{"type":"system_warning_operation","value":{"message":"THREE OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(4, 0, 1) )
         , ( hafd.make_block_id(5, 1), 0, 0, 0, 1, '{"type":"system_warning_operation","value":{"message":"FIVEFIVE OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(5, 0, 1) )
         , ( hafd.make_block_id(6, 1), 0, 0, 0, 1, '{"type":"system_warning_operation","value":{"message":"SIX OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(6, 0, 1) )
         , ( hafd.make_block_id(7, 1), 0, 0, 0, 1, '{"type":"system_warning_operation","value":{"message":"SEVEN0 OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(7, 0, 1) ) -- must be abandon because of fork2
         , ( hafd.make_block_id(7, 1), 1, 0, 1, 1, '{"type":"system_warning_operation","value":{"message":"SEVEN01 OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(7, 1, 1) ) -- must be abandon because of fork2
         , ( hafd.make_block_id(7, 1), 2, 0, 2, 1, '{"type":"system_warning_operation","value":{"message":"SEVEN02 OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(7, 2, 1) ) -- must be abandon because of fork2
         , ( hafd.make_block_id(7, 2), 0, 0, 0, 1, '{"type":"system_warning_operation","value":{"message":"SEVEN2 OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(7, 0, 1) )
         , ( hafd.make_block_id(7, 2), 1, 0, 1, 1, '{"type":"system_warning_operation","value":{"message":"SEVEN21 OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(7, 1, 1) )
         , ( hafd.make_block_id(8, 2), 0, 0, 0, 1, '{"type":"system_warning_operation","value":{"message":"EAIGHT2 OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(8, 0, 1) )
         , ( hafd.make_block_id(9, 2), 0, 0, 0, 1, '{"type":"system_warning_operation","value":{"message":"NINE2 OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(9, 0, 1) )
         , ( hafd.make_block_id(8, 3), 0, 0, 0, 1, '{"type":"system_warning_operation","value":{"message":"EIGHT3 OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(8, 0, 1) )
         , ( hafd.make_block_id(9, 3), 0, 0, 0, 1, '{"type":"system_warning_operation","value":{"message":"NINE3 OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(9, 0, 1) )
         , ( hafd.make_block_id(10, 3), 0, 0, 0, 1, '{"type":"system_warning_operation","value":{"message":"TEN OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(10, 0, 1) )
    ;
