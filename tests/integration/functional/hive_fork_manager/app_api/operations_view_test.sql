...
BEGIN
    ...
    ASSERT NOT EXISTS (
        ...
        EXCEPT SELECT * FROM ( VALUES
              ( hafd.operation_id(1, 0), 1, 0, 0, 0, '\x520e5a45524f204f5045524154494f4e' :: hafd.operation, '{"type":"system_warning_operation","value":{"message":"ZERO OPERATION"}}' :: jsonb )
            , ( hafd.operation_id(2, 0), 2, 0, 0, 0, '\x520d4f4e45204f5045524154494f4e' :: hafd.operation, '{"type":"system_warning_operation","value":{"message":"ONE OPERATION"}}' :: jsonb )
            , ( hafd.operation_id(3, 0), 3, 0, 0, 0, '\x520d54574f204f5045524154494f4e' :: hafd.operation, '{"type":"system_warning_operation","value":{"message":"TWO OPERATION"}}' :: jsonb )
            , ( hafd.operation_id(4, 0), 4, 0, 0, 0, '\x520f5448524545204f5045524154494f4e' :: hafd.operation, '{"type":"system_warning_operation","value":{"message":"THREE OPERATION"}}' :: jsonb )
            , ( hafd.operation_id(5, 0), 5, 0, 0, 0, '\x520e46495645204f5045524154494f4e' :: hafd.operation, '{"type":"system_warning_operation","value":{"message":"FIVE OPERATION"}}' :: jsonb )
            , ( hafd.operation_id(6, 0), 6, 0, 0, 0, '\x520d534958204f5045524154494f4e' :: hafd.operation, '{"type":"system_warning_operation","value":{"message":"SIX OPERATION"}}' :: jsonb )
            , ( hafd.operation_id(7, 0), 7, 0, 0, 0, '\x5210534556454e32204f5045524154494f4e' :: hafd.operation, '{"type":"system_warning_operation","value":{"message":"SEVEN2 OPERATION"}}' :: jsonb )
            , ( hafd.operation_id(7, 1), 7, 0, 1, 0, '\x5211534556454e3231204f5045524154494f4e' :: hafd.operation, '{"type":"system_warning_operation","value":{"message":"SEVEN21 OPERATION"}}' :: jsonb )
            , ( hafd.operation_id(7, 2), 7, 0, 2, 0, '\x5211534556454e3032204f5045524154494f4e' :: hafd.operation, '{"type":"system_warning_operation","value":{"message":"SEVEN02 OPERATION"}}' :: jsonb )
            , ( hafd.operation_id(8, 0), 8, 0, 0, 0, '\x5210454947485433204f5045524154494f4e' :: hafd.operation, '{"type":"system_warning_operation","value":{"message":"EIGHT3 OPERATION"}}' :: jsonb )
            , ( hafd.operation_id(9, 0), 9, 0, 0, 0, '\x520f4e494e4533204f5045524154494f4e' :: hafd.operation, '{"type":"system_warning_operation","value":{"message":"NINE3 OPERATION"}}' :: jsonb )
            , ( hafd.operation_id(10, 0), 10, 0, 0, 0,'\x520d54454e204f5045524154494f4e' :: hafd.operation, '{"type":"system_warning_operation","value":{"message":"TEN OPERATION"}}' :: jsonb )
        ) as pattern
