...
BEGIN
    ...
    VALUES
    ( hafd.make_block_id(1, 0), 0, '\xBAAD10' )
         , ( hafd.make_block_id(2, 0), 0, '\xBAAD20' )
         , ( hafd.make_block_id(3, 0), 0, '\xBAAD30' )
         , ( hafd.make_block_id(4, 0), 0, '\xBAAD40' )
         , ( hafd.make_block_id(5, 0), 0, '\xBAAD50' )
    ;
    ...
    VALUES
         ...
         , ( hafd.make_block_id(7, 1), 0, 1, 0, 0, '{"type":"system_warning_operation","value":{"message":"SEVEN0 OPERATION"}}' :: jsonb :: hafd.operation ) -- must be abandon because of fork2
         , ( hafd.make_block_id(7, 1), 1, 1, 0, 1, '{"type":"system_warning_operation","value":{"message":"SEVEN01 OPERATION"}}' :: jsonb :: hafd.operation ) -- must be abandon because of fork2
         , ( hafd.make_block_id(7, 1), 2, 1, 0, 2, '{"type":"system_warning_operation","value":{"message":"SEVEN02 OPERATION"}}' :: jsonb :: hafd.operation ) -- must be abandon because of fork2
