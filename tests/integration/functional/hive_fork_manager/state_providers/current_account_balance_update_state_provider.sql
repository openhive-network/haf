...
BEGIN
    ...
    PERFORM hive.app_state_provider_import( 'c_a_b_s_t', 'context' ,'/home/hived/datadir/context'); -- mtlk todo now
...
$BODY$
BEGIN
    ASSERT 1 = (SELECT * FROM hive.consensus_state_provider_get_expected_block_num('context', '/home/hived/datadir/context')), 'consensus_state_provider_get_expected_block_num should return 1'; -- mtlk todo now
...
DECLARE
BEGIN
    ASSERT 7 = (SELECT * FROM hive.consensus_state_provider_get_expected_block_num('context', '/home/hived/datadir/context')), 'consensus_state_provider_get_expected_block_num should return 7'; -- mtlk todo now
    ...
    ASSERT 1 = (SELECT * FROM hive.consensus_state_provider_get_expected_block_num('context', '/home/hived/datadir/context')); -- mtlk todo now
