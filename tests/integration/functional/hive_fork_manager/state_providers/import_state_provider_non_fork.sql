...
BEGIN
    ...
    ASSERT ( SELECT COUNT(*) FROM hive_data.registered_tables WHERE origin_table_schema = 'hive' AND origin_table_name = 'context_accounts' AND context_id = 1 ) = 0, 'State provider table is registered';
END;
$BODY$
;
