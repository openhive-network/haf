...
BEGIN
    ...
    CREATE TABLE table1( id INTEGER NOT NULL, smth hive.ctext NOT NULL ) INHERITS( a.context );
    CREATE TABLE table2( id INTEGER NOT NULL, smth hive.ctext NOT NULL ) INHERITS( a.context );
