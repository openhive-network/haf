...
BEGIN
    ...
    FOR i IN 101..103 LOOP
        ...
        __transaction = ( i, 0::SMALLINT, decode('DE' || lpad(to_hex(i), 4, '0'), 'hex'), i, 100, '2016-06-22 19:10:25-07'::timestamp, '\xBEEF', 20 );
        __operation = ( hafd.operation_id(i, 0), 0, 1, 0, '{"message":"BLOCK"}'::jsonb, NULL );
