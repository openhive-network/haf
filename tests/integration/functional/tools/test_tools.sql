...
BEGIN
    ...
    ( 4, 0, 0, 1, 0, '{"type":"system_warning_operation","value":{"message":"THREE OPERATION"}}' :: jsonb :: hafd.operation, 1 )
         ...
         , ( 7, 0, 0, 1, 0, '{"type":"system_warning_operation","value":{"message":"SEVEN0 OPERATION"}}' :: jsonb :: hafd.operation, 1 )
         , ( 7, 1, 0, 1, 1, '{"type":"system_warning_operation","value":{"message":"SEVEN01 OPERATION"}}' :: jsonb :: hafd.operation, 1 )
         , ( 7, 2, 0, 1, 2, '{"type":"system_warning_operation","value":{"message":"SEVEN02 OPERATION"}}' :: jsonb :: hafd.operation, 1 )
    ...
    VALUES
    ( 4, 4, 1, 4, 0, 1,  1 ) -- block 4 (1)
         , ( 5, 5, 1, 5, 0, 1,  1 ) -- block 5 (1)
         , ( 6, 6, 1, 6, 0, 1,  1 ) -- block 6 (1)
         , ( 7, 7, 1, 7, 0, 1,  1 ) -- block 7(1), must be overriden by fork 2
         , ( 8, 8, 1, 7, 0, 1,  1 ) -- block 7(1), must be overriden by fork 2
         , ( 9, 9, 1, 7, 2, 1,  1 ) -- block 7(1), must be overriden by fork 2
         , ( 7, 7, 2, 9, 0, 1,  2 ) -- block 9 (2)
         , ( 9, 9, 2, 7, 0, 1,  2 ) -- block 7(2)
         , ( 9, 9, 3, 8, 0, 1,  2 ) -- block 8(2) -- block 8(3) has not operation
         , ( 4, 4, 2, 7, 0, 1,  2 ) -- block 7(2)
         , ( 10, 10, 2, 9, 0, 1, 2 ) -- block 9(2)
         , ( 10, 10, 3, 9, 0, 1, 3 ) -- block 9(3)
         , ( 11, 11, 3, 9, 0, 1, 3 ) -- block 9(3)
    ;
