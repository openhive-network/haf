...
BEGIN
    ...
    INSERT INTO hafd.account_operations(block_id, account_id, transacting_account_id, account_op_seq_no, operation_id, op_type_id)
    VALUES
           ( hafd.make_block_id( 1, 0 ), 1, 1, 1, hafd.operation_id(1, 0), 0 )
         , ( hafd.make_block_id( 2, 0 ), 1, 1, 2, hafd.operation_id(2, 0), 0 )
         , ( hafd.make_block_id( 2, 0 ), 2, 2, 1, hafd.operation_id(2, 0), 0 )
         , ( hafd.make_block_id( 3, 0 ), 3, 3, 1, hafd.operation_id(3, 0), 0 )
         , ( hafd.make_block_id( 4, 0 ), 4, 4, 1, hafd.operation_id(4, 0), 0 )
    ;
    ...
    ( 1, hafd.make_block_id( 1, 0 ), hafd.operation_id(1,1) )
         ...
         , ( 3, hafd.make_block_id( 3, 0 ), hafd.operation_id(3,1) )
         , ( 4, hafd.make_block_id( 4, 0 ), hafd.operation_id(4,1) )
         , ( 5, hafd.make_block_id( 5, 0 ), hafd.operation_id(5,1) )
    ;
    ...
    ( hafd.make_block_id( 4, 1 ), 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"THREE OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(4, 0) )
         ...
         , ( hafd.make_block_id( 7, 1 ), 0, 0, 0, '{"type":"system_warning_operation","value":{"message":"SEVEN0 OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(7, 0) )
         , ( hafd.make_block_id( 7, 1 ), 0, 0, 1, '{"type":"system_warning_operation","value":{"message":"SEVEN01 OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(7, 1) )
         , ( hafd.make_block_id( 7, 1 ), 0, 0, 2, '{"type":"system_warning_operation","value":{"message":"SEVEN02 OPERATION"}}' :: jsonb :: hafd.operation, hafd.operation_id(7, 2) )
    ...
    INSERT INTO hafd.account_operations(block_id, account_id, transacting_account_id, account_op_seq_no, operation_id, op_type_id)
    VALUES
    ( hafd.make_block_id( 4, 1 ), 4, 4, 1, hafd.operation_id(4, 0), 0 )
         , ( hafd.make_block_id( 5, 1 ), 5, 5, 1, hafd.operation_id(5, 0), 0 )
         , ( hafd.make_block_id( 6, 1 ), 6, 6, 1, hafd.operation_id(6, 0), 0 )
         , ( hafd.make_block_id( 7, 1 ), 7, 7, 1, hafd.operation_id(7, 0), 0 )
         , ( hafd.make_block_id( 7, 1 ), 8, 8, 1, hafd.operation_id(7, 0), 0 )
         , ( hafd.make_block_id( 7, 1 ), 9, 9, 1, hafd.operation_id(7, 2), 0 )
         , ( hafd.make_block_id( 9, 2 ), 7, 7, 2, hafd.operation_id(9, 0), 0 )
         , ( hafd.make_block_id( 7, 2 ), 9, 9, 2, hafd.operation_id(7, 0), 0 ) -- block 7(2)
         , ( hafd.make_block_id( 8, 2 ), 9, 9, 3, hafd.operation_id(8, 0), 0 ) -- block 8(2)
         , ( hafd.make_block_id( 7, 2 ), 4, 4, 2, hafd.operation_id(7, 0), 0 ) -- block 7(2)
         , ( hafd.make_block_id( 9, 2 ), 10, 10, 2, hafd.operation_id(9, 0), 0 ) -- block 9(2)
         , ( hafd.make_block_id( 9, 3 ), 10, 10, 3, hafd.operation_id(9, 0), 0 ) -- block 9(3)
         , ( hafd.make_block_id( 9, 3 ), 11, 11, 3, hafd.operation_id(9, 0), 0 ) -- block 9(3)
    ;
    ...
    VALUES
         ...
         , ( 7, hafd.make_block_id( 7, 1 ), hafd.operation_id(7,1) )
         , ( 8, hafd.make_block_id( 7, 1 ), hafd.operation_id(7,1) )
         , ( 9, hafd.make_block_id( 7, 1 ), hafd.operation_id(7,2) )
         , ( 7, hafd.make_block_id( 7, 2 ), hafd.operation_id(7,1) )
         , ( 8, hafd.make_block_id( 7, 2 ), hafd.operation_id(7,1) )
         , ( 9, hafd.make_block_id( 8, 2 ), hafd.operation_id(8,1) )
         , ( 10, hafd.make_block_id( 9, 2 ), hafd.operation_id(9,1) )
         , ( 9, hafd.make_block_id( 8, 3 ), hafd.operation_id(8,1) )
         , ( 10, hafd.make_block_id( 9, 3 ), hafd.operation_id(9,1) )
         , ( 11, hafd.make_block_id( 10, 3 ), hafd.operation_id(10,1) )
    ;
