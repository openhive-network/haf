...
bash "${CURRENT_PROJECT_DIR}/json_metadata_comparison/process_klive.sh"
...
python3 $CURRENT_PROJECT_DIR/json_metadata_comparison/data_insertion_script.py --script_dir="$CURRENT_PROJECT_DIR"/account_data --host="/var/run/postgresql" #--debug
