...
def test_double_production(prepared_networks_and_database_12_8_with_double_production, extra_witnesses):
...
# update?        #UPDATE hive.contexts
    ...
    create_app(session_1, APPLICATION_CONTEXT)
    ...
    wallet_0 = tt.Wallet(attach_to=witness_node_0)
    wallet_1 = tt.Wallet(attach_to=witness_node_1)
    ...
    # witness_node_0.wait_number_of_blocks(1)

    witness_node_0.wait_for_next_fork(timeout=threading.TIMEOUT_MAX)

    witness_node_1.close()
