...
from local_tools import run_networks, get_head_block, run_networks, wait_for_irreversible_progress, get_irreversible_block, create_app, update_app_continuously, wait_for_application_context
...
def test_application_broken(world_with_witnesses_and_database):
    ...
    wait_for_irreversible_progress(node_under_test, START_TEST_BLOCK + 30)
