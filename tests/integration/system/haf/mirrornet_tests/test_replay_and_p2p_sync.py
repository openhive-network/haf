...
def test_replay_and_p2p_sync():
    ...
    raw_node.config.plugin = 'condenser_api database_api block_api account_history_api market_history_api network_broadcast_api witness account_by_key account_by_key_api wallet_bridge_api'
