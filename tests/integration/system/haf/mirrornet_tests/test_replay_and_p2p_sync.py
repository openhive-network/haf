...
def test_replay_and_p2p_sync(database):
    ...
    raw_node.run(replay_from=path_block_log_100k, time_offset=timestamp_blok_100k, wait_for_live=True, timeout=sleep_time, arguments=['--chain-id', '42', '--skeleton-key', '5JNHfZYKGaomSFvd4NUdQ9qMcEAC43kujbfjueTHpVapX1Kzq2n'])
