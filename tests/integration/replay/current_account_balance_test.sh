...
$SETUP_SCRIPTS_PATH/../src/hive_fork_manager/state_providers/consensus_state_provider/scripts/run_app.sh app_start || true
...
$SETUP_SCRIPTS_PATH/../src/hive_fork_manager/state_providers/consensus_state_provider/scripts/run_app.sh app_cont
