...
BEGIN
    ...
    WHILE true LOOP
            ...
            SELECT fork_id INTO __head_block_fork_id FROM hive.blocks_reversible WHERE num = hive.app_get_current_block_num( 'test' );
            RAISE NOTICE 'Fork id % for current block', __head_block_fork_id;
