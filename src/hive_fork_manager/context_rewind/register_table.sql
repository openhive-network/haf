...
DECLARE
    ...
    __hive_insert_trigger_name TEXT;
    __hive_delete_trigger_name TEXT;
    __hive_update_trigger_name TEXT;
    __hive_truncate_trigger_name TEXT;
    __hive_triggerfunction_name_insert TEXT;
    __hive_triggerfunction_name_delete TEXT;
    __hive_triggerfunction_name_update TEXT;
    __hive_triggerfunction_name_truncate TEXT;
...
BEGIN
    ...
    IF __is_lite_schema THEN
        -- Lite schema: no shadow table, no rowid, no triggers
        __shadow_table_name := '';
    ...
    -- Full schema: create shadow table, rowid, triggers, revert functions
    __shadow_table_name := hive.get_shadow_table_name( _table_schema, _table_name );
    __hive_insert_trigger_name := hive.get_trigger_insert_name( _table_schema,  _table_name );
    __hive_delete_trigger_name := hive.get_trigger_delete_name( _table_schema,  _table_name );
    __hive_update_trigger_name := hive.get_trigger_update_name( _table_schema,  _table_name );
    __hive_truncate_trigger_name := hive.get_trigger_truncate_name( _table_schema,  _table_name );
    __hive_triggerfunction_name_insert := hive.get_trigger_insert_function_name( _table_schema,  _table_name );
    __hive_triggerfunction_name_delete := hive.get_trigger_delete_function_name( _table_schema,  _table_name );
    __hive_triggerfunction_name_update := hive.get_trigger_update_function_name( _table_schema,  _table_name );
    __hive_triggerfunction_name_truncate := hive.get_trigger_truncate_function_name( _table_schema,  _table_name );
...
BEGIN
    ...
    IF __is_lite_schema THEN
        -- Lite schema: no shadow table, triggers, or rowid to clean up
