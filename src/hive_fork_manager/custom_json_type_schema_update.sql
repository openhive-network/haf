...
-- Note: op_type_id for both operations and account_operations is a separate column
-- stored explicitly by the C++ serializer and push_block. Not derived from operation_id.
