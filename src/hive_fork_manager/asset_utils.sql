...
CREATE OR REPLACE FUNCTION hive.decode_asset_symbol(IN _symbol hafd.asset_symbol)
RETURNS hive.asset_symbol_info 
AS 'MODULE_PATHNAME', 'decode_asset_symbol' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE OR REPLACE FUNCTION hive.get_paired_symbol(IN _symbol hafd.asset_symbol)
RETURNS hafd.asset_symbol
AS 'MODULE_PATHNAME', 'get_paired_asset_symbol' LANGUAGE C IMMUTABLE STRICT PARALLEL SAFE;

CREATE OR REPLACE FUNCTION hive.asset_symbol_to_nai_string(IN _symbol hafd.asset_symbol)
RETURNS TEXT 
