...
CREATE INDEX IF NOT EXISTS hive_account_operations_reversible_type_account_id_op_seq_idx ON hive.account_operations_reversible( hive.operation_id_to_type_id_wrapper( operation_id ), account_id, account_op_seq_no DESC, operation_id, hive.operation_id_to_block_num_wrapper(operation_id) );
