...
GRANT ALL ON hafd.app_indices_contexts_map TO hive_applications_group;
...
GRANT EXECUTE ON FUNCTION
    ...
    , hive.operation_id_to_pos( _id hafd.operations.id%TYPE )
    , hive.operation_id_to_type_id( _id hafd.operations.id%TYPE )
    , hive.operation_id_to_block_num( _id hafd.operations.id%TYPE )
    , hive.operation_id_to_pos( _id hafd.operations.id%TYPE )
    , hive.operation_id_to_type_id( _id hafd.operations.id%TYPE )
    , hive.operation_id_to_block_num( _id hafd.operations.id%TYPE )
