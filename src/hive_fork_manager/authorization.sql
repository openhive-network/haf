...
GRANT EXECUTE ON FUNCTION
    ...
    , hive.connect( _git_sha TEXT, _block_num hafd.blocks.num%TYPE, _first_block hafd.blocks.num%TYPE, _pruning integer, _pruning_min_contexts integer )
    , hive.is_pruning_enabled()
    , hive.is_pruning_allowed()
