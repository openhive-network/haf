...
GRANT EXECUTE ON FUNCTION
    ...
    , hive._operation_out(hive_data.operation)
    , hive._operation_bin_in_internal(internal)
    , hive._operation_bin_in(bytea)
    , hive._operation_bin_out(hive_data.operation)
    , hive._operation_eq(hive_data.operation, hive_data.operation)
    , hive._operation_ne(hive_data.operation, hive_data.operation)
    , hive._operation_gt(hive_data.operation, hive_data.operation)
    , hive._operation_ge(hive_data.operation, hive_data.operation)
    , hive._operation_lt(hive_data.operation, hive_data.operation)
    , hive._operation_le(hive_data.operation, hive_data.operation)
    , hive._operation_cmp(hive_data.operation, hive_data.operation)
    , hive._operation_to_jsonb(hive_data.operation)
    , hive._operation_from_jsonb(jsonb)
    , hive.operation_to_jsontext(hive_data.operation)
