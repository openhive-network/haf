...
CREATE TYPE hive_data.operation(
    INPUT = hive._operation_in -- JSON string -> hive_data.operation
  , OUTPUT = hive._operation_out -- hive_data.operation -> JSON string

  , RECEIVE = hive._operation_bin_in_internal -- internal -> hive_data.operation
  , SEND = hive._operation_bin_out -- hive_data.operation -> bytea
