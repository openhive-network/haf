-- Process an operation given in `op` record.  It should be any record type containing `body` and `op_type_id` columns of types `hive_data.operation` and `smallint` respectively.
