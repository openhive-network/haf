...
-- `raise_on_undefined_function` tells whether an exception should be raised if user provided function is not implemented for operation type given in `op_type_id`.
-- Any exception raised by user provided function will be reraised.
