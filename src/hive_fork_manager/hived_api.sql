...
DECLARE
    __fork_id BIGINT;
BEGIN
    CALL hive.dlogs('<no-context>', 'Entering back_from_fork');
    ...
    CALL hive.dlogs('<no-context>', 'Exiting back_from_fork');
...
BEGIN
    CALL hive.dlogs('<no-context>', 'Entering push_block');
    ...
    CALL hive.dlogs('<no-context>', 'Exiting push_block');
...
BEGIN
    CALL hive.dlogs('<no-context>', 'Entering set_irreversible');
    ...
    CALL hive.dlogs('<no-context>', 'Exiting set_irreversible');
...
$BODY$
BEGIN
    CALL hive.dlogs('<no-context>', 'Entering end_massive_sync');
    ...
    UPDATE hive.irreversible_data SET consistent_block = _block_num;
    CALL hive.dlogs('<no-context>', 'Exiting end_massive_sync');
...
$BODY$
BEGIN
    CALL hive.dlogs('<no-context>', 'Entering set_irreversible_dirty');
    UPDATE hive.irreversible_data SET is_dirty = TRUE;
    CALL hive.dlogs('<no-context>', 'Exiting set_irreversible_dirty');
...
$BODY$
BEGIN
    CALL hive.dlogs('<no-context>', 'Entering set_irreversible_not_dirty');
    UPDATE hive.irreversible_data SET is_dirty = FALSE;
    CALL hive.dlogs('<no-context>', 'Exiting set_irreversible_not_dirty');
...
$BODY$
BEGIN
    CALL hive.dlogs('<no-context>', 'Entering disable_indexes_of_irreversible');
    ...
    CALL hive.dlogs('<no-context>', 'Exiting disable_indexes_of_irreversible');
END;
$BODY$
;
...
$BODY$
BEGIN
    CALL hive.dlogs('<no-context>', 'Entering disable_fk_of_irreversible');
    ...
    CALL hive.dlogs('<no-context>', 'Exiting disable_fk_of_irreversible');
...
$BODY$
BEGIN
    CALL hive.dlogs('<no-context>', 'Entering enable_indexes_of_irreversible');
    ...
    CALL hive.dlogs('<no-context>', 'Exiting enable_indexes_of_irreversible');
...
$BODY$
BEGIN
    CALL hive.dlogs('<no-context>', 'Entering enable_fk_of_irreversible');
    ...
    CALL hive.dlogs('<no-context>', 'Exiting enable_fk_of_irreversible');
...
$BODY$
BEGIN
    CALL hive.dlogs('<no-context>', 'Entering disable_indexes_of_reversible');
    ...
    CALL hive.dlogs('<no-context>', 'Exiting disable_indexes_of_reversible');
...
BEGIN
    CALL hive.dlogs('<no-context>', 'Entering enable_indexes_of_reversible');
    ...
    CALL hive.dlogs('<no-context>', 'Exiting enable_indexes_of_reversible');
END;
$BODY$
;
...
$BODY$
BEGIN
    CALL hive.dlogs('<no-context>', 'Entering connect');
    ...
    CALL hive.dlogs('<no-context>', 'Exiting connect');
END;
$BODY$
;
...
BEGIN
    CALL hive.dlogs('<no-context>', 'Entering get_block_header');
    ...
    CALL hive.dlogs('<no-context>', 'Exiting get_block_header');
