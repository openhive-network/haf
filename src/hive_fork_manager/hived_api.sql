...
$BODY$
BEGIN
    PERFORM hive.save_and_drop_indexes_constraints( 'hive', 'irreversible_data_the_table' );
...
$BODY$
BEGIN
    PERFORM hive.save_and_drop_indexes_foreign_keys( 'hive', 'irreversible_data_the_table' );
