...
BEGIN
    ...
    INSERT INTO hafd.operations_reversible(block_num, op_pos_in_block, trx_in_block, op_type_id, op_pos, body_binary, custom_json_type_id, fork_id)
      SELECT block_num, op_pos_in_block, trx_in_block, op_type_id, op_pos, body_binary, custom_json_type_id, __fork_id FROM unnest( _operations );
