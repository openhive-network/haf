...
BEGIN
    PERFORM hive.dlog(_context, '"Entering app_context_attach" _last_synced_block=%I', _last_synced_block);
    ...
    PERFORM hive.dlog(_context, '"Exiting app_context_attach" _last_synced_block=%I', _last_synced_block);
END;
$BODY$
;
...
$BODY$
BEGIN
    PERFORM hive.dlog(_context, '"Entering app_register_table" _table_schema=%s, _table_name=%s', _table_schema, _table_name);
    ...
    PERFORM hive.dlog(_context, '"Exiting app_register_table" _table_schema=%s, _table_name=%s', _table_schema, _table_name);
END;
$BODY$
;
...
$BODY$
BEGIN
    PERFORM hive.dlog('no-context', '"Entering app_unregister_table" _table_schema=%s, _table_name=%s', _table_schema, _table_name);
...
DECLARE
    __context_id hive.contexts.id%TYPE;
BEGIN
    PERFORM hive.dlog(_context_name, '"Entering app_context_detached_save_block_num" _block_num=%I', _block_num);
    ...
    END IF;
    PERFORM hive.dlog(_context_name, '"Exiting app_context_detached_save_block_num" _block_num=%I', _block_num);
END;
$BODY$;
...
DECLARE
    __context_id hive.contexts.id%TYPE;
BEGIN
    PERFORM hive.dlog(_context, '"Entering app_state_provider_import" _state_provider=%s', _state_provider::TEXT);
    SELECT hac.id
    ...
    PERFORM hive.dlog(_context, '"Exiting app_state_provider_import" _state_provider=%s', _state_provider::TEXT);
END;
$BODY$
;
...
$BODY$
BEGIN
    PERFORM hive.dlog(_context, '"Entering app_state_provider_drop" _state_provider=%s', _state_provider::TEXT);
    EXECUTE format(
    ...
    PERFORM hive.dlog(_context, '"Exiting app_state_provider_drop" _state_provider=%s', _state_provider::TEXT);
END;
$BODY$
;
