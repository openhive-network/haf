...
namespace consensus_state_provider
{
  ...
  void csp_finish_impl(const csp_session_type*, bool wipe_clean_shared_memory_bin);
  int consensus_state_provider_get_expected_block_num_impl(const consensus_state_provider::csp_session_type* csp_session);
  ...
  collected_account_balances_collection_t collect_current_all_accounts_balances_impl(const csp_session_type* );
  collected_account_balances_collection_t collect_current_account_balances(const csp_session_type* csp_session, const std::vector<std::string>& accounts);
  collected_account_balances_collection_t collect_current_account_balances_impl(const csp_session_type* , const std::vector<std::string>& accounts);
