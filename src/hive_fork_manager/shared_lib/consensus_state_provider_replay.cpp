...
private:
  ...
  static full_block_ptr from_bin_to_full_block_ptr(block_bin_t& sb, int block_num);
...
full_block_ptr postgres_block_log::from_bin_to_full_block_ptr(block_bin_t& sb, int block_num)
{
  switch(block_num)
  {
    // clang-format off
