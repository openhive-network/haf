...
// // csp_session_ptr_type csp_session_ptr = nullptr;
// //   PsqlTools::PsqlUtils::pg_call_cxx([=,&csp_session_ptr]()
// //   {
// //   // Dynamically allocate csp_session_type. Ownership transfers to SQL hive.session
// //     csp_session_ptr = new csp_session_type(context, shared_memory_bin_path, postgres_url);
