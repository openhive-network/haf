CREATE TABLE IF NOT EXISTS hive_data.fork(
...
SELECT pg_catalog.pg_extension_config_dump('hive_data.fork', '');
SELECT pg_catalog.pg_extension_config_dump('hive_data.fork_id_seq', '');
