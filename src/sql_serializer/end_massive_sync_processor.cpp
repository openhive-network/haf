...
namespace sql_serializer {
    ...
    end_massive_sync_processor::end_massive_sync_processor( std::string psqlUrl, synchronicity_data::synchronicity_data_ptr synchronicity )
    {
      ...
      _data_processor = std::make_unique< queries_commit_data_processor >(psqlUrl, "commiting hive.end_massive_sync", commiting_function, nullptr, synchronicity );
    }
