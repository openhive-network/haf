...
namespace hive::plugins::sql_serializer {
  class queries_commit_data_processor
    ...
    public:
      ...
      queries_commit_data_processor( const std::string& psqlUrl, std::string description, std::string short_description,
                                     const data_processing_fn& dataProcessor, std::shared_ptr< block_num_rendezvous_trigger > api_trigger, appbase::application& app );
