...
BEGIN
    ...
    --ASSERT EXISTS ( SELECT * FROM hive.context_accounts WHERE name = 'STM4xmWJcNo2UyJMbWZ6cjVpi4NYuL1ViyPrPgmqCDMKdckkeagEB' ), 'key STM4xmWJcNo2UyJMbWZ6cjVpi4NYuL1ViyPrPgmqCDMKdckkeagEB from update not found';
