...
load_database(){
  ...
  # TimescaleDB restore protocol: pre_restore sets timescaledb.restoring='on'
  # which (a) stops background workers, (b) signals our extension SQL to skip
  # hypertable creation (the dump already contains the hypertable metadata),
  # and (c) allows pg_restore to load chunk data correctly.
