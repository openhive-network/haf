...
print_help () {
    ...
    echo
    echo "Script for building Docker image of Hive instance and pushing it to GitLab registry and to Docker Hub"
...
# Tag instance image
docker tag "${CI_REGISTRY_IMAGE}/instance:instance-${CI_COMMIT_TAG}" "hiveio/haf:${CI_COMMIT_TAG}"

docker images

# Push instance images
docker push "${CI_REGISTRY_IMAGE}/instance:instance-${CI_COMMIT_TAG}"
docker push "hiveio/haf:${CI_COMMIT_TAG}"